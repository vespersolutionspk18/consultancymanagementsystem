...
import { FieldMetadataType, RelationOnDeleteAction } from 'cms-shared/types';
...
import { WorkspaceIsNotAuditLogged } from 'src/engine/cms-orm/decorators/workspace-is-not-audit-logged.decorator';
...
export class TimelineActivityWorkspaceEntity extends BaseWorkspaceEntity {
  ...
  @WorkspaceRelation({
    standardId: TIMELINE_ACTIVITY_STANDARD_FIELD_IDS.targetProject,
    type: RelationType.MANY_TO_ONE,
    label: msg`Project`,
  ...
  @WorkspaceIsFieldUIReadOnly()
  @WorkspaceIsNullable()
  targetProject: Relation<ProjectWorkspaceEntity> | null;

  @WorkspaceJoinColumn('targetProject')
