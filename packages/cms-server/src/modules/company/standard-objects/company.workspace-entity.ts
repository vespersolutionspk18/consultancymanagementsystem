...
export class CompanyWorkspaceEntity extends BaseWorkspaceEntity {
  ...
  @WorkspaceRelation({
    standardId: COMPANY_STANDARD_FIELD_IDS.project,
    type: RelationType.MANY_TO_ONE,
    label: msg`Project`,
    description: msg`Project linked to the company`,
    icon: 'IconTargetArrow',
    inverseSideTarget: () => ProjectWorkspaceEntity,
    inverseSideFieldKey: 'companies',
    onDelete: RelationOnDeleteAction.SET_NULL,
  })
  @WorkspaceIsNullable()
  ...
  @WorkspaceRelation({
    standardId: COMPANY_STANDARD_FIELD_IDS.sectors,
    type: RelationType.ONE_TO_MANY,
    label: msg`Sectors`,
    description: msg`Sectors linked to the company.`,
    icon: 'IconCategory',
  ...
  @WorkspaceField({
    standardId: COMPANY_STANDARD_FIELD_IDS.expertise,
    type: FieldMetadataType.RICH_TEXT_V2,
    label: msg`Expertise`,
    description: msg`Company expertise and capabilities`,
    icon: 'IconBulb',
  })
  @WorkspaceIsNullable()
  expertise: RichTextV2Metadata | null;
