...
const widgetSchema = z.object({
  ...
  objectMetadataId: z
    ...
    .optional()
    .describe(
      'REQUIRED for GRAPH widgets: UUID of the object to aggregate (e.g., project, company)',
    ),
...
1. GRAPH with graphType "AGGREGATE" (KPI number):
   ...
   - Example: { type: "GRAPH", objectMetadataId: "<project-object-uuid>", configuration: { graphType: "AGGREGATE", aggregateFieldMetadataId: "<amount-field-uuid>", aggregateOperation: "SUM" } }
