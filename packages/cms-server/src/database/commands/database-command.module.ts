...
import { ComputeCMSStandardWorkspaceMigrationCommand } from 'src/database/commands/compute-cms-standard-workspace-migration.command';
...
@Module({
  ...
  providers: [
    ComputeCMSStandardWorkspaceMigrationCommand,
