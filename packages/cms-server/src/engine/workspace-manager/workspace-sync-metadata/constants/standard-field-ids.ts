...
export const ACTIVITY_TARGET_STANDARD_FIELD_IDS = {
  ...
  project: '20202020-1fc2-4af1-8c91-7901ee0fd38b',
...
export const ATTACHMENT_STANDARD_FIELD_IDS = {
  ...
  project: '20202020-7374-499d-bea3-9354890755b5',
...
export const COMPANY_STANDARD_FIELD_IDS = {
  ...
  project: '20202020-add3-4658-8e23-d70dccb6d0ec',
  sectors: '20202020-e5f6-7a8b-c9d0-1e2f3a4b5c6d',
  expertise: '20202020-f6a7-8b9c-d0e1-2f3a4b5c6d7e',
...
export const TIMELINE_ACTIVITY_STANDARD_FIELD_IDS = {
  ...
  targetProject: '20202020-7664-4a35-a3df-580d389fd527',
...
export const FAVORITE_STANDARD_FIELD_IDS = {
  ...
  project: '20202020-dabc-48e1-8318-2781a2b32aa2',
...
export const NOTE_TARGET_STANDARD_FIELD_IDS = {
  ...
  project: '20202020-4e42-417a-a705-76581c9ade79',
...
export const PROJECT_STANDARD_FIELD_IDS = {
  ...
  submissionDate: '20202020-527e-44d6-b1ac-c4158d307b97',
  preSubmissionDeadline: '20202020-d1a0-4b5c-8e2f-1a2b3c4d5e6f',
  probabilityDeprecated: '20202020-69d4-45f3-9703-690b09fafcf0',
  stage: '20202020-6f76-477d-8551-28cd65b2b4b9',
  client: '20202020-c11e-4a1b-8c2d-3e4f5a6b7c81',
  clientContactNumber: '20202020-cc0a-4b2c-8d3e-4f5a6b7c8d92',
  clientEmail: '20202020-ce1a-4c3d-8e4f-5a6b7c8d9ea3',
  clientAddress: '20202020-ca0d-4d4e-8f50-6b7c8d9e0fb4',
  fundedBy: '20202020-f00d-4e5f-8061-7c8d9e0f1a25',
  bidSecurity: '20202020-b1d5-4f60-8172-8d9e0f1a2b36',
  projectDuration: '20202020-d00a-4071-8283-9e0f1a2b3c47',
  documentsAvailableAndApplication: '20202020-d0c5-4a2b-8c3d-4e5f6a7b8c9d',
  procurementDetails: '20202020-9c0d-4b3c-8d4e-5f6a7b8c9d0e',
  ...
  companies: '20202020-cbac-457e-b565-adece5fc815f',
  sectors: '20202020-5ec0-4a1b-9c2d-3e4f5a6b7c8d',
  ...
  chats: '20202020-9c02-4e53-b5c8-9e3a6b8d7c11',
} as const;

export const PROJECT_CHAT_STANDARD_FIELD_IDS = {
  title: '20202020-9c03-4e53-b5c8-9e3a6b8d7c12',
  messages: '20202020-9c04-4e53-b5c8-9e3a6b8d7c13',
  selectedFiles: '20202020-9c05-4e53-b5c8-9e3a6b8d7c14',
  position: '20202020-9c06-4e53-b5c8-9e3a6b8d7c15',
  createdBy: '20202020-9c07-4e53-b5c8-9e3a6b8d7c16',
  project: '20202020-9c08-4e53-b5c8-9e3a6b8d7c17',
} as const;
...
export const PERSON_STANDARD_FIELD_IDS = {
  ...
  pointOfContactForProjects: '20202020-911b-4a7d-b67b-918aa9a5b33a',
  // TODO: check if activityTargets field can be deleted
  ...
  // New person fields
  dateOfBirth: '20202020-a100-d0b0-0000-000000000001',
  totalProfessionalExperience: '20202020-a200-e5e0-0000-000000000002',
  nationality: '20202020-a300-a0e0-0000-000000000003',
  cnicPassportNumber: '20202020-a400-c0a0-0000-000000000004',
  intro: '20202020-a500-1e00-0000-000000000005',
  // Relations to new entities
  educations: '20202020-a600-ed00-0000-000000000006',
  certifications: '20202020-a700-ce00-0000-000000000007',
  pastExperiences: '20202020-a800-bea5-0000-000000000008',
  employmentRecords: '20202020-a900-e0b1-0000-000000000009',
} as const;

export const EDUCATION_STANDARD_FIELD_IDS = {
  degree: '20202020-ed00-de00-0000-000000000001',
  majorMinor: '20202020-ed00-0a00-0000-000000000002',
  institution: '20202020-ed00-1050-0000-000000000003',
  country: '20202020-ed00-c000-0000-000000000004',
  yearOfCompletion: '20202020-ed00-ea00-0000-000000000005',
  person: '20202020-ed00-be00-0000-000000000006',
  position: '20202020-ed00-b051-0000-000000000007',
  createdBy: '20202020-ed00-c0ea-0000-000000000008',
} as const;

export const CERTIFICATION_STANDARD_FIELD_IDS = {
  certificate: '20202020-ce20-0a0e-0000-000000000001',
  majorMinor: '20202020-ce20-0a00-0000-000000000002',
  institution: '20202020-ce20-1050-0000-000000000003',
  country: '20202020-ce20-c000-0000-000000000004',
  yearOfCompletion: '20202020-ce20-ea00-0000-000000000005',
  person: '20202020-ce20-be00-0000-000000000006',
  position: '20202020-ce20-b051-0000-000000000007',
  createdBy: '20202020-ce20-c0ea-0000-000000000008',
} as const;

export const PAST_EXPERIENCE_STANDARD_FIELD_IDS = {
  projectIdentification: '20202020-bea5-b01d-0000-000000000001',
  clientName: '20202020-bea5-c1e0-0000-000000000002',
  assignmentTitle: '20202020-bea5-e1e1-0000-000000000003',
  sectorType: '20202020-bea5-5ec0-0000-000000000004',
  scopeDeliverables: '20202020-bea5-5c0b-0000-000000000005',
  briefDescription: '20202020-bea5-de5c-0000-000000000006',
  keyResponsibilities: '20202020-bea5-0e5b-0000-000000000007',
  roleInAssignment: '20202020-bea5-001e-0000-000000000008',
  startDate: '20202020-bea5-5ed0-0000-000000000009',
  endDate: '20202020-bea5-e0d0-0000-000000000010',
  durationMonths: '20202020-bea5-d000-0000-000000000011',
  projectValue: '20202020-bea5-b0a1-0000-000000000012',
  person: '20202020-bea5-be00-0000-000000000013',
  position: '20202020-bea5-b051-0000-000000000014',
  createdBy: '20202020-bea5-c0ea-0000-000000000015',
} as const;

export const EMPLOYMENT_RECORD_STANDARD_FIELD_IDS = {
  employerName: '20202020-e0b1-0a0e-0000-000000000001',
  country: '20202020-e0b1-c000-0000-000000000002',
  province: '20202020-e0b1-b000-0000-000000000003',
  positionDesignation: '20202020-e0b1-b05d-0000-000000000004',
  fromDate: '20202020-e0b1-f0de-0000-000000000005',
  toDate: '20202020-e0b1-e0de-0000-000000000006',
  jobDescription: '20202020-e0b1-0d5c-0000-000000000007',
  person: '20202020-e0b1-be00-0000-000000000008',
  position: '20202020-e0b1-b051-0000-000000000009',
  createdBy: '20202020-e0b1-c0ea-0000-000000000010',
} as const;

export const SECTOR_STANDARD_FIELD_IDS = {
  name: '20202020-a1b2-4c3d-8e5f-6a7b8c9d0e1f',
  company: '20202020-b2c3-4d5e-9f0a-1b2c3d4e5f6a',
  project: '20202020-e5f6-4a5b-9c0d-1e2f3a4b5c6d',
  position: '20202020-c3d4-5e6f-a0b1-2c3d4e5f6a7b',
  createdBy: '20202020-d4e5-6f7a-b1c2-3d4e5f6a7b8c',
  searchVector: '20202020-e5f6-7a8b-c2d3-4e5f6a7b8c9d',
} as const;
...
export const TASK_TARGET_STANDARD_FIELD_IDS = {
  ...
  project: '20202020-6cb2-4c01-a9a5-aca3dbc11d41',
...
export const STANDARD_OBJECT_FIELD_IDS = {
  ...
  projectChat: PROJECT_CHAT_STANDARD_FIELD_IDS,
  person: PERSON_STANDARD_FIELD_IDS,
  sector: SECTOR_STANDARD_FIELD_IDS,
