...
import { OPPORTUNITY_DATA_SEEDS } from 'src/engine/workspace-manager/dev-seeder/data/constants/project-data-seeds.constant';
import {
  PERSON_DATA_SEEDS,
...
export class TimelineActivitySeederService {
  ...
  async seedTimelineActivities({
    ...
    const entityConfigs: EntityConfig[] = [
      ...
      { type: 'project', seeds: OPPORTUNITY_DATA_SEEDS },
    ];
  ...
  private getEventAfterRecordProperties(
    ...
    const propertyGetters = {
      ...
      project: () => ({
        ...
        submissionDate: recordSeed.submissionDate,
      }),
      calendarEvent: () => ({
        ...commonProperties,
        title: recordSeed.title,
  ...
  private getNoteTargetInfos(
    ...
    const targetChecks = [
      ...
      { id: noteTargetSeed.projectId, type: 'project' },
    ];
  ...
  private getTaskTargetInfos(
    ...
    const targetChecks = [
      ...
      { id: taskTargetSeed.projectId, type: 'project' },
    ];
  ...
  private computeLinkedActivityRecord({
    ...
    // Set target ID (person, company, or project)
