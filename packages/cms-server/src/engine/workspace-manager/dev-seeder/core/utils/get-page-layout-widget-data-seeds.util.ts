...
export const getPageLayoutWidgetDataSeeds = (
  ...
  const projectStageFieldId = getFieldId(projectObject, 'stage');
  ...
  const projectIdFieldId = getFieldId(projectObject, 'id');
  ...
  const v1Widgets = [
    ...
    isDefined(projectStageFieldId)
      ? {
          ...
          configuration: {
            ...
            secondaryAxisGroupByFieldMetadataId: projectStageFieldId,
    ...
    isDefined(projectIdFieldId)
      ? {
          ...
          configuration: {
            graphType: 'AGGREGATE',
            aggregateFieldMetadataId: projectIdFieldId,
            aggregateOperation: AggregateOperations.COUNT,
            displayDataLabel: true,
            timezone: 'UTC',
            firstDayOfTheWeek: CalendarStartDay.MONDAY,
