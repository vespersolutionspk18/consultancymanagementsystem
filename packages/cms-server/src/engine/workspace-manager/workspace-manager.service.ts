...
export class WorkspaceManagerService {
  ...
  public async init({
    ...
    const cmsStandardApplication =
      await this.applicationService.createCMSStandardApplication({
        workspaceId,
      });
    ...
    if (isV2SyncEnabled) {
      ...
      await this.prefillWorkspaceWithStandardObjectsRecords({
        ...
        workspaceId,
        featureFlags,
        cmsStandardFlatApplication: fromApplicationEntityToFlatApplication(
          cmsStandardApplication,
        ),
      });
