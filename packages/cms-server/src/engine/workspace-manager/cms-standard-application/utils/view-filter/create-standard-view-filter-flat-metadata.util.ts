import { type ViewFilterOperand } from 'cms-shared/types';
...
import { type AllStandardObjectViewFilterName } from 'src/engine/workspace-manager/cms-standard-application/types/all-standard-object-view-filter-name.type';
