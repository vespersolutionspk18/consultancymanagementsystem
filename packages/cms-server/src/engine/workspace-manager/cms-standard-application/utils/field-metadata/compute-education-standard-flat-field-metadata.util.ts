...
export const buildEducationStandardFlatFieldMetadatas = ({
  now,
  objectName,
  workspaceId,
  ...
  CreateStandardFieldArgs<'education', FieldMetadataType>,
  'context'
>): Record<AllStandardObjectFieldName<'education'>, FlatFieldMetadata> => ({
  ...
  majorMinor: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      type: FieldMetadataType.TEXT,
      label: 'Major / Minor',
      description: 'Major or minor field of study',
      icon: 'IconBook',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  yearOfCompletion: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      description: 'Year or date of completion',
  ...
  person: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      fieldName: 'person',
      label: 'Person',
      description: 'Person this education belongs to',
      icon: 'IconUser',
      isNullable: true,
