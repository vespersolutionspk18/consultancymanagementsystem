...
import { computeStandardProjectViewGroups } from 'src/engine/workspace-manager/cms-standard-application/utils/view-group/compute-standard-project-view-groups.util';
import { type CreateStandardViewGroupArgs } from 'src/engine/workspace-manager/cms-standard-application/utils/view-group/create-standard-view-group-flat-metadata.util';
import { computeStandardTaskViewGroups } from 'src/engine/workspace-manager/cms-standard-application/utils/view-group/compute-standard-task-view-groups.util';
...
const STANDARD_FLAT_VIEW_GROUP_METADATA_BUILDERS_BY_OBJECT_NAME = {
  project: computeStandardProjectViewGroups,
