...
import {
  ...
  CERTIFICATION_STANDARD_FIELD_IDS,
  COMPANY_STANDARD_FIELD_IDS,
  CONNECTED_ACCOUNT_STANDARD_FIELD_IDS,
  DASHBOARD_STANDARD_FIELD_IDS,
  EDUCATION_STANDARD_FIELD_IDS,
  EMPLOYMENT_RECORD_STANDARD_FIELD_IDS,
  ...
  PAST_EXPERIENCE_STANDARD_FIELD_IDS,
  PERSON_STANDARD_FIELD_IDS,
  PROJECT_CHAT_STANDARD_FIELD_IDS,
  PROJECT_STANDARD_FIELD_IDS,
  SECTOR_STANDARD_FIELD_IDS,
...
export const STANDARD_OBJECTS = {
  attachment: {
    ...
    fields: {
      ...
      project: {
        universalIdentifier: ATTACHMENT_STANDARD_FIELD_IDS.project,
      },
      dashboard: {
  ...
  company: {
    ...
    fields: {
      ...
      project: {
        universalIdentifier: COMPANY_STANDARD_FIELD_IDS.project,
      },
      ...
      sectors: {
        universalIdentifier: COMPANY_STANDARD_FIELD_IDS.sectors,
      },
      expertise: {
        universalIdentifier: COMPANY_STANDARD_FIELD_IDS.expertise,
      },
    },
    indexes: {
      accountOwnerIdIndex: {
      ...
      projectIdIndex: {
        universalIdentifier: 'c5c1e6f0-7b92-4d5a-6e4f-91d2e03f4447',
      },
  ...
  favorite: {
    ...
    fields: {
      ...
      project: {
        universalIdentifier: FAVORITE_STANDARD_FIELD_IDS.project,
      },
  ...
  noteTarget: {
    ...
    fields: {
      ...
      project: {
        universalIdentifier: NOTE_TARGET_STANDARD_FIELD_IDS.project,
      },
    },
    indexes: {
      noteIdIndex: {
  ...
  project: {
    universalIdentifier: STANDARD_OBJECT_IDS.project,
    fields: {
      ...
      name: { universalIdentifier: PROJECT_STANDARD_FIELD_IDS.name },
      amount: { universalIdentifier: PROJECT_STANDARD_FIELD_IDS.amount },
      submissionDate: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.submissionDate,
      },
      stage: { universalIdentifier: PROJECT_STANDARD_FIELD_IDS.stage },
      preSubmissionDeadline: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.preSubmissionDeadline,
      },
      probabilityDeprecated: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.probabilityDeprecated,
      },
      client: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.client,
      },
      clientContactNumber: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.clientContactNumber,
      },
      clientEmail: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.clientEmail,
      },
      clientAddress: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.clientAddress,
      },
      fundedBy: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.fundedBy,
      },
      bidSecurity: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.bidSecurity,
      },
      projectDuration: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.projectDuration,
      },
      documentsAvailableAndApplication: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.documentsAvailableAndApplication,
      },
      procurementDetails: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.procurementDetails,
      },
      position: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.position,
      },
      createdBy: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.createdBy,
      },
      pointOfContact: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.pointOfContact,
      },
      companies: { universalIdentifier: PROJECT_STANDARD_FIELD_IDS.companies },
      favorites: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.favorites,
      },
      activityTargets: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.activityTargets,
      },
      taskTargets: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.taskTargets,
      },
      noteTargets: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.noteTargets,
      },
      attachments: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.attachments,
      },
      timelineActivities: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.timelineActivities,
      },
      searchVector: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.searchVector,
      },
      sectors: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.sectors,
      },
      chats: {
        universalIdentifier: PROJECT_STANDARD_FIELD_IDS.chats,
      },
    },
    indexes: {
  ...
  person: {
    ...
    fields: {
      ...
      pointOfContactForProjects: {
        universalIdentifier:
          PERSON_STANDARD_FIELD_IDS.pointOfContactForProjects,
      },
      taskTargets: {
      ...
      dateOfBirth: {
        universalIdentifier: PERSON_STANDARD_FIELD_IDS.dateOfBirth,
      },
      totalProfessionalExperience: {
        universalIdentifier: PERSON_STANDARD_FIELD_IDS.totalProfessionalExperience,
      },
      nationality: {
        universalIdentifier: PERSON_STANDARD_FIELD_IDS.nationality,
      },
      cnicPassportNumber: {
        universalIdentifier: PERSON_STANDARD_FIELD_IDS.cnicPassportNumber,
      },
      intro: {
        universalIdentifier: PERSON_STANDARD_FIELD_IDS.intro,
      },
      educations: {
        universalIdentifier: PERSON_STANDARD_FIELD_IDS.educations,
      },
      certifications: {
        universalIdentifier: PERSON_STANDARD_FIELD_IDS.certifications,
      },
      pastExperiences: {
        universalIdentifier: PERSON_STANDARD_FIELD_IDS.pastExperiences,
      },
      employmentRecords: {
        universalIdentifier: PERSON_STANDARD_FIELD_IDS.employmentRecords,
      },
    },
    indexes: {
      companyIdIndex: {
  ...
  taskTarget: {
    ...
    fields: {
      ...
      project: {
        universalIdentifier: TASK_TARGET_STANDARD_FIELD_IDS.project,
      },
    },
    indexes: {
      taskIdIndex: {
  ...
  timelineActivity: {
    ...
    fields: {
      ...
      targetProject: {
        universalIdentifier:
          TIMELINE_ACTIVITY_STANDARD_FIELD_IDS.targetProject,
      },
      targetTask: {
  ...
  sector: {
    universalIdentifier: STANDARD_OBJECT_IDS.sector,
    fields: {
      id: { universalIdentifier: '20202020-5e00-0001-0000-000000000001' },
      createdAt: { universalIdentifier: '20202020-5e00-0002-0000-000000000002' },
      updatedAt: { universalIdentifier: '20202020-5e00-0003-0000-000000000003' },
      deletedAt: { universalIdentifier: '20202020-5e00-0004-0000-000000000004' },
      name: { universalIdentifier: SECTOR_STANDARD_FIELD_IDS.name },
      company: { universalIdentifier: SECTOR_STANDARD_FIELD_IDS.company },
      project: { universalIdentifier: SECTOR_STANDARD_FIELD_IDS.project },
      position: { universalIdentifier: SECTOR_STANDARD_FIELD_IDS.position },
      createdBy: { universalIdentifier: SECTOR_STANDARD_FIELD_IDS.createdBy },
      searchVector: { universalIdentifier: SECTOR_STANDARD_FIELD_IDS.searchVector },
    },
    indexes: {
      companyIdIndex: { universalIdentifier: '20202020-5e00-1de1-0000-000000000001' },
      projectIdIndex: { universalIdentifier: '20202020-5e00-1de2-0000-000000000002' },
      searchVectorGinIndex: { universalIdentifier: '20202020-5e00-1de3-0000-000000000003' },
    },
  },
  education: {
    universalIdentifier: STANDARD_OBJECT_IDS.education,
    fields: {
      id: { universalIdentifier: '20202020-ed01-0001-0000-000000000001' },
      createdAt: { universalIdentifier: '20202020-ed01-0002-0000-000000000002' },
      updatedAt: { universalIdentifier: '20202020-ed01-0003-0000-000000000003' },
      deletedAt: { universalIdentifier: '20202020-ed01-0004-0000-000000000004' },
      degree: { universalIdentifier: EDUCATION_STANDARD_FIELD_IDS.degree },
      majorMinor: { universalIdentifier: EDUCATION_STANDARD_FIELD_IDS.majorMinor },
      institution: { universalIdentifier: EDUCATION_STANDARD_FIELD_IDS.institution },
      country: { universalIdentifier: EDUCATION_STANDARD_FIELD_IDS.country },
      yearOfCompletion: { universalIdentifier: EDUCATION_STANDARD_FIELD_IDS.yearOfCompletion },
      person: { universalIdentifier: EDUCATION_STANDARD_FIELD_IDS.person },
      position: { universalIdentifier: EDUCATION_STANDARD_FIELD_IDS.position },
      createdBy: { universalIdentifier: EDUCATION_STANDARD_FIELD_IDS.createdBy },
    },
    indexes: {
      personIdIndex: { universalIdentifier: '20202020-ed01-1de1-0000-000000000001' },
    },
  },
  certification: {
    universalIdentifier: STANDARD_OBJECT_IDS.certification,
    fields: {
      id: { universalIdentifier: '20202020-ce01-0001-0000-000000000001' },
      createdAt: { universalIdentifier: '20202020-ce01-0002-0000-000000000002' },
      updatedAt: { universalIdentifier: '20202020-ce01-0003-0000-000000000003' },
      deletedAt: { universalIdentifier: '20202020-ce01-0004-0000-000000000004' },
      certificate: { universalIdentifier: CERTIFICATION_STANDARD_FIELD_IDS.certificate },
      majorMinor: { universalIdentifier: CERTIFICATION_STANDARD_FIELD_IDS.majorMinor },
      institution: { universalIdentifier: CERTIFICATION_STANDARD_FIELD_IDS.institution },
      country: { universalIdentifier: CERTIFICATION_STANDARD_FIELD_IDS.country },
      yearOfCompletion: { universalIdentifier: CERTIFICATION_STANDARD_FIELD_IDS.yearOfCompletion },
      person: { universalIdentifier: CERTIFICATION_STANDARD_FIELD_IDS.person },
      position: { universalIdentifier: CERTIFICATION_STANDARD_FIELD_IDS.position },
      createdBy: { universalIdentifier: CERTIFICATION_STANDARD_FIELD_IDS.createdBy },
    },
    indexes: {
      personIdIndex: { universalIdentifier: '20202020-ce01-1de1-0000-000000000001' },
    },
  },
  pastExperience: {
    universalIdentifier: STANDARD_OBJECT_IDS.pastExperience,
    fields: {
      id: { universalIdentifier: '20202020-be01-0001-0000-000000000001' },
      createdAt: { universalIdentifier: '20202020-be01-0002-0000-000000000002' },
      updatedAt: { universalIdentifier: '20202020-be01-0003-0000-000000000003' },
      deletedAt: { universalIdentifier: '20202020-be01-0004-0000-000000000004' },
      projectIdentification: { universalIdentifier: PAST_EXPERIENCE_STANDARD_FIELD_IDS.projectIdentification },
      clientName: { universalIdentifier: PAST_EXPERIENCE_STANDARD_FIELD_IDS.clientName },
      assignmentTitle: { universalIdentifier: PAST_EXPERIENCE_STANDARD_FIELD_IDS.assignmentTitle },
      sectorType: { universalIdentifier: PAST_EXPERIENCE_STANDARD_FIELD_IDS.sectorType },
      scopeDeliverables: { universalIdentifier: PAST_EXPERIENCE_STANDARD_FIELD_IDS.scopeDeliverables },
      briefDescription: { universalIdentifier: PAST_EXPERIENCE_STANDARD_FIELD_IDS.briefDescription },
      keyResponsibilities: { universalIdentifier: PAST_EXPERIENCE_STANDARD_FIELD_IDS.keyResponsibilities },
      roleInAssignment: { universalIdentifier: PAST_EXPERIENCE_STANDARD_FIELD_IDS.roleInAssignment },
      startDate: { universalIdentifier: PAST_EXPERIENCE_STANDARD_FIELD_IDS.startDate },
      endDate: { universalIdentifier: PAST_EXPERIENCE_STANDARD_FIELD_IDS.endDate },
      durationMonths: { universalIdentifier: PAST_EXPERIENCE_STANDARD_FIELD_IDS.durationMonths },
      projectValue: { universalIdentifier: PAST_EXPERIENCE_STANDARD_FIELD_IDS.projectValue },
      person: { universalIdentifier: PAST_EXPERIENCE_STANDARD_FIELD_IDS.person },
      position: { universalIdentifier: PAST_EXPERIENCE_STANDARD_FIELD_IDS.position },
      createdBy: { universalIdentifier: PAST_EXPERIENCE_STANDARD_FIELD_IDS.createdBy },
    },
    indexes: {
      personIdIndex: { universalIdentifier: '20202020-be01-1de1-0000-000000000001' },
    },
  },
  employmentRecord: {
    universalIdentifier: STANDARD_OBJECT_IDS.employmentRecord,
    fields: {
      id: { universalIdentifier: '20202020-e001-0001-0000-000000000001' },
      createdAt: { universalIdentifier: '20202020-e001-0002-0000-000000000002' },
      updatedAt: { universalIdentifier: '20202020-e001-0003-0000-000000000003' },
      deletedAt: { universalIdentifier: '20202020-e001-0004-0000-000000000004' },
      employerName: { universalIdentifier: EMPLOYMENT_RECORD_STANDARD_FIELD_IDS.employerName },
      country: { universalIdentifier: EMPLOYMENT_RECORD_STANDARD_FIELD_IDS.country },
      province: { universalIdentifier: EMPLOYMENT_RECORD_STANDARD_FIELD_IDS.province },
      positionDesignation: { universalIdentifier: EMPLOYMENT_RECORD_STANDARD_FIELD_IDS.positionDesignation },
      fromDate: { universalIdentifier: EMPLOYMENT_RECORD_STANDARD_FIELD_IDS.fromDate },
      toDate: { universalIdentifier: EMPLOYMENT_RECORD_STANDARD_FIELD_IDS.toDate },
      jobDescription: { universalIdentifier: EMPLOYMENT_RECORD_STANDARD_FIELD_IDS.jobDescription },
      person: { universalIdentifier: EMPLOYMENT_RECORD_STANDARD_FIELD_IDS.person },
      position: { universalIdentifier: EMPLOYMENT_RECORD_STANDARD_FIELD_IDS.position },
      createdBy: { universalIdentifier: EMPLOYMENT_RECORD_STANDARD_FIELD_IDS.createdBy },
    },
    indexes: {
      personIdIndex: { universalIdentifier: '20202020-e101-1de1-0000-000000000001' },
    },
  },
  projectChat: {
    universalIdentifier: STANDARD_OBJECT_IDS.projectChat,
    fields: {
      id: { universalIdentifier: '20202020-bc01-0001-0000-000000000001' },
      createdAt: { universalIdentifier: '20202020-bc01-0002-0000-000000000002' },
      updatedAt: { universalIdentifier: '20202020-bc01-0003-0000-000000000003' },
      deletedAt: { universalIdentifier: '20202020-bc01-0004-0000-000000000004' },
      title: { universalIdentifier: PROJECT_CHAT_STANDARD_FIELD_IDS.title },
      messages: { universalIdentifier: PROJECT_CHAT_STANDARD_FIELD_IDS.messages },
      selectedFiles: { universalIdentifier: PROJECT_CHAT_STANDARD_FIELD_IDS.selectedFiles },
      position: { universalIdentifier: PROJECT_CHAT_STANDARD_FIELD_IDS.position },
      createdBy: { universalIdentifier: PROJECT_CHAT_STANDARD_FIELD_IDS.createdBy },
      project: { universalIdentifier: PROJECT_CHAT_STANDARD_FIELD_IDS.project },
    },
    indexes: {
      projectIdIndex: { universalIdentifier: '20202020-bc01-1de1-0000-000000000001' },
    },
  },
