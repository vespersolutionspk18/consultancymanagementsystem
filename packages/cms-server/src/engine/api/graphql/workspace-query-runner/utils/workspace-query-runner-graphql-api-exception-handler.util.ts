...
import { CMSORMException } from 'src/engine/cms-orm/exceptions/cms-orm.exception';
import { cmsORMGraphqlApiExceptionHandler } from 'src/engine/cms-orm/utils/cms-orm-graphql-api-exception-handler.util';
...
export const workspaceQueryRunnerGraphqlApiExceptionHandler = (
  ...
  switch (true) {
    ...
    case error instanceof CMSORMException:
      return cmsORMGraphqlApiExceptionHandler(error);
