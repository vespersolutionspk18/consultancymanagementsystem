...
> {
  ...
  @Inject()
  protected readonly cmsConfigService: CMSConfigService;
  @Inject()
  ...
  private async throttleQueryExecution(authContext: WorkspaceAuthContext) {
    try {
      ...
      const shortConfig = {
        ...
        maxTokens: this.cmsConfigService.get(
          'API_RATE_LIMITING_SHORT_LIMIT',
        ),
        timeWindow: this.cmsConfigService.get(
      ...
      const longConfig = {
        ...
        maxTokens: this.cmsConfigService.get('API_RATE_LIMITING_LONG_LIMIT'),
        timeWindow: this.cmsConfigService.get(
  ...
  private validateQueryComplexity(
    ...
    const maximumComplexity = this.cmsConfigService.get(
