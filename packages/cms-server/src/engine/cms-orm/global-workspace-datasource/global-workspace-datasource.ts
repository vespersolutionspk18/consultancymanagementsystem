import { type ObjectsPermissionsByRoleId } from 'cms-shared/types';
...
import { WorkspaceEntityManager } from 'src/engine/cms-orm/entity-manager/workspace-entity-manager';
import { type WorkspaceQueryRunner } from 'src/engine/cms-orm/query-runner/workspace-query-runner';
import { type WorkspaceRepository } from 'src/engine/cms-orm/repository/workspace.repository';
