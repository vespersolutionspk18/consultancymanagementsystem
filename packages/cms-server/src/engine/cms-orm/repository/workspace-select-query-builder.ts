...
import { WorkspaceDeleteQueryBuilder } from 'src/engine/cms-orm/repository/workspace-delete-query-builder';
import { WorkspaceInsertQueryBuilder } from 'src/engine/cms-orm/repository/workspace-insert-query-builder';
import { WorkspaceSoftDeleteQueryBuilder } from 'src/engine/cms-orm/repository/workspace-soft-delete-query-builder';
import { WorkspaceUpdateQueryBuilder } from 'src/engine/cms-orm/repository/workspace-update-query-builder';
...
> extends SelectQueryBuilder<T> {
  ...
  override async execute(): Promise<any> {
    try {
      ...
      throw await computeCMSORMException(error);
    }
  }
