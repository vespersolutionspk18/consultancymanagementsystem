...
import { type DeepPartialWithNestedRelationFields } from 'src/engine/cms-orm/entity-manager/types/deep-partial-entity-with-nested-relation-fields.type';
...
import { getEntityTarget } from 'src/engine/cms-orm/entity-manager/utils/get-entity-target';
import { computeCMSORMException } from 'src/engine/cms-orm/error-handling/compute-cms-orm-exception';
import { type GlobalWorkspaceDataSource } from 'src/engine/cms-orm/global-workspace-datasource/global-workspace-datasource';
import { RelationNestedQueries } from 'src/engine/cms-orm/relation-nested-queries/relation-nested-queries';
import {
  type OperationType,
  validateOperationIsPermittedOrThrow,
} from 'src/engine/cms-orm/repository/permissions.utils';
import { WorkspaceSelectQueryBuilder } from 'src/engine/cms-orm/repository/workspace-select-query-builder';
import { WorkspaceRepository } from 'src/engine/cms-orm/repository/workspace.repository';
import { getWorkspaceContext } from 'src/engine/cms-orm/storage/orm-workspace-context.storage';
import { type RolePermissionConfig } from 'src/engine/cms-orm/types/role-permission-config';
import { computePermissionIntersection } from 'src/engine/cms-orm/utils/compute-permission-intersection.util';
