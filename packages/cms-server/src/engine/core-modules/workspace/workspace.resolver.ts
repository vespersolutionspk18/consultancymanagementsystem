...
import { assertIsDefinedOrThrow, isDefined } from 'cms-shared/utils';
...
export class WorkspaceResolver {
  ...
  hasValidEnterpriseKey(): boolean {
    return isDefined(this.cmsConfigService.get('ENTERPRISE_KEY'));
  }
  ...
  isGoogleAuthEnabled(@Parent() workspace: WorkspaceEntity) {
    return (
      ...
      this.cmsConfigService.get('AUTH_GOOGLE_ENABLED')
    );
  }
  ...
  isMicrosoftAuthEnabled(@Parent() workspace: WorkspaceEntity) {
    return (
      ...
      this.cmsConfigService.get('AUTH_MICROSOFT_ENABLED')
    );
  }
  ...
  isPasswordAuthEnabled(@Parent() workspace: WorkspaceEntity) {
    return (
      ...
      this.cmsConfigService.get('AUTH_PASSWORD_ENABLED')
    );
  }
