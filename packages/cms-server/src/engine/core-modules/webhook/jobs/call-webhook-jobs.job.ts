...
import type { ObjectRecordEvent } from 'cms-shared/database-events';
...
export class CallWebhookJobsJob {
  ...
  async handle(
    ...
    // trigger in packages/cms-zapier/src/triggers/trigger_record.ts
    // Also change the openApi schema for webhooks
    // packages/cms-server/src/engine/core-modules/open-api/utils/computeWebhooks.utils.ts
