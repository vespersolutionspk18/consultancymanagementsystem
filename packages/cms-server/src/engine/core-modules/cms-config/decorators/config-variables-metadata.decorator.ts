...
import { type ConfigVariableType } from 'src/engine/core-modules/cms-config/enums/config-variable-type.enum';
import { type ConfigVariablesGroup } from 'src/engine/core-modules/cms-config/enums/config-variables-group.enum';
import { type ConfigVariableOptions } from 'src/engine/core-modules/cms-config/types/config-variable-options.type';
import { applyBasicValidators } from 'src/engine/core-modules/cms-config/utils/apply-basic-validators.util';
