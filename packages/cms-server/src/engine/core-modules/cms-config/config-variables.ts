...
import { type AwsRegion } from 'src/engine/core-modules/cms-config/interfaces/aws-region.interface';
...
import { CastToLogLevelArray } from 'src/engine/core-modules/cms-config/decorators/cast-to-log-level-array.decorator';
import { CastToMeterDriverArray } from 'src/engine/core-modules/cms-config/decorators/cast-to-meter-driver.decorator';
import { CastToPositiveNumber } from 'src/engine/core-modules/cms-config/decorators/cast-to-positive-number.decorator';
import { CastToUpperSnakeCase } from 'src/engine/core-modules/cms-config/decorators/cast-to-upper-snake-case.decorator';
import { ConfigVariablesMetadata } from 'src/engine/core-modules/cms-config/decorators/config-variables-metadata.decorator';
import { IsAWSRegion } from 'src/engine/core-modules/cms-config/decorators/is-aws-region.decorator';
import { IsDuration } from 'src/engine/core-modules/cms-config/decorators/is-duration.decorator';
import { IsOptionalOrEmptyString } from 'src/engine/core-modules/cms-config/decorators/is-optional-or-empty-string.decorator';
import { IsStrictlyLowerThan } from 'src/engine/core-modules/cms-config/decorators/is-strictly-lower-than.decorator';
import { IsCMSSemVer } from 'src/engine/core-modules/cms-config/decorators/is-cms-semver.decorator';
import { ConfigVariableType } from 'src/engine/core-modules/cms-config/enums/config-variable-type.enum';
import { ConfigVariablesGroup } from 'src/engine/core-modules/cms-config/enums/config-variables-group.enum';
import {
  ConfigVariableException,
  ConfigVariableExceptionCode,
} from 'src/engine/core-modules/cms-config/cms-config.exception';
...
export class ConfigVariables {
  ...
  @ConfigVariablesMetadata({
    group: ConfigVariablesGroup.OTHER,
    description:
      'Prefills default credentials in the login form, used in local development for quicker sign-in',
    type: ConfigVariableType.BOOLEAN,
  })
  @IsOptional()
  ...
  EMAIL_FROM_NAME = 'Felix from CMS';
  ...
  @ConfigVariablesMetadata({
    ...
    isSensitive: true,
    description:
      'Comma-separated list of Gemini API keys for rotation (supports multiple free tier keys)',
    type: ConfigVariableType.STRING,
  })
  @IsOptional()
  ...
  @ConfigVariablesMetadata({
    group: ConfigVariablesGroup.SERVER_CONFIG,
    description: 'CMS server version',
    type: ConfigVariableType.STRING,
    isEnvOnly: true,
  })
