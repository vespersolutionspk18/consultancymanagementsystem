...
import { PermissionFlagType } from 'cms-shared/constants';
...
import { ConfigVariableGraphqlApiExceptionFilter } from 'src/engine/core-modules/cms-config/filters/config-variable-graphql-api-exception.filter';
...
export class AdminPanelResolver {
  ...
  async getDatabaseConfigVariable(
    ...
    this.cmsConfigService.validateConfigVariableExists(key as string);
  ...
  async createDatabaseConfigVariable(
    ...
    await this.cmsConfigService.set(key, value);
  ...
  async updateDatabaseConfigVariable(
    ...
    await this.cmsConfigService.update(key, value);
  ...
  async deleteDatabaseConfigVariable(
    ...
    await this.cmsConfigService.delete(key);
