...
const CMSConfigServiceGetAllMock = jest.fn();
const CMSConfigServiceGetVariableWithMetadataMock = jest.fn();

jest.mock(
  'src/engine/core-modules/cms-config/constants/config-variables-group-metadata',
  () => ({
...
describe('AdminPanelService', () => {
        ...
        },
        {
          ...
          useValue: {
            getWorkspaceUrls: jest.fn().mockReturnValue({
              customUrl: undefined,
              subdomainUrl: 'https://cms.cms.com',
            }),
          },
        },
        {
          ...
          useValue: {
            getAll: CMSConfigServiceGetAllMock,
            getVariableWithMetadata:
              CMSConfigServiceGetVariableWithMetadataMock,
          },
        },
        {
  ...
  describe('getConfigVariablesGrouped', () => {
    it('should correctly group and sort config variables', () => {
      CMSConfigServiceGetAllMock.mockReturnValue({
        SERVER_URL: {
  ...
  describe('getVersionInfo', () => {
    ...
    beforeEach(() => {
      ...
      service['cmsConfigService'].get = mockEnvironmentGet;
    });
  ...
  describe('getConfigVariable', () => {
    it('should return config variable with all fields', () => {
      CMSConfigServiceGetVariableWithMetadataMock.mockReturnValue({
        value: 'test-value',
        metadata: {
          group: 'SERVER_CONFIG',
    ...
    it('should throw error when variable not found', () => {
      CMSConfigServiceGetVariableWithMetadataMock.mockReturnValue(undefined);
