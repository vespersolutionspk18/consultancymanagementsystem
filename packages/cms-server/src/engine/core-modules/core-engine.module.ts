...
import { ProjectChatModule } from 'src/modules/project-chat/project-chat.module';
...
@Module({
  imports: [
    ...
    MessageQueueModule.registerAsync({
      ...
      inject: [CMSConfigService, RedisClientService],
    }),
    ExceptionHandlerModule.forRootAsync({
      useFactory: exceptionHandlerModuleFactory,
      inject: [CMSConfigService, HttpAdapterHost],
    }),
    EmailModule.forRoot(),
    ...
    ServerlessModule.forRootAsync({
      ...
      inject: [CMSConfigService, FileStorageService],
    }),
