...
import { CMS_MCP_HELPER } from 'src/engine/core-modules/tool/tools/code-interpreter-tool/cms-mcp-helper.const';
...
export class CodeInterpreterTool implements Tool {
  ...
  async execute(
    ...
    try {
      ...
      const codeWithHelper = CMS_MCP_HELPER + '\n\n' + code;
