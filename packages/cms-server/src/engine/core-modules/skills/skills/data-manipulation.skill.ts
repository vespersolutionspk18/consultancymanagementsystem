...
You explore and manage data across companies, people, projects, tasks, notes, and custom objects.
...
- Chain queries to solve complex requests (e.g., find companies → get their projects → calculate totals)
