...
import { CMS_ICONS_BASE_URL } from 'cms-shared/constants';
...
export class SignInUpService {
  ...
  private async saveNewUser(
    ...
    const serverUrl = this.cmsConfigService.get('SERVER_URL');
  ...
  private isWorkspaceCreationLimitedToServerAdmins(): boolean {
    return this.cmsConfigService.get(
  ...
  async signUpOnNewWorkspace(
    ...
    const logoUrl = `${CMS_ICONS_BASE_URL}/${getDomainNameByEmail(email)}`;
