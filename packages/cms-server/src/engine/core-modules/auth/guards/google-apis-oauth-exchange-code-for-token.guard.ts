...
export class GoogleAPIsOauthExchangeCodeForTokenGuard extends AuthGuard(
  ...
  async canActivate(context: ExecutionContext) {
    try {
      ...
      if (
        !this.cmsConfigService.get('MESSAGING_PROVIDER_GMAIL_ENABLED') &&
        !this.cmsConfigService.get('CALENDAR_PROVIDER_GOOGLE_ENABLED')
      ) {
      ...
      new GoogleAPIsOauthExchangeCodeForTokenStrategy(this.cmsConfigService);
