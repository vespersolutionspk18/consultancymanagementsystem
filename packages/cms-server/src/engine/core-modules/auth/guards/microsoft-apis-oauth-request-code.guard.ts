...
export class MicrosoftAPIsOauthRequestCodeGuard extends AuthGuard(
  ...
  async canActivate(context: ExecutionContext) {
    ...
    try {
      if (
        !this.cmsConfigService.get('MESSAGING_PROVIDER_MICROSOFT_ENABLED') &&
        !this.cmsConfigService.get('CALENDAR_PROVIDER_MICROSOFT_ENABLED')
      ) {
      ...
      new MicrosoftAPIsOauthRequestCodeStrategy(this.cmsConfigService);
