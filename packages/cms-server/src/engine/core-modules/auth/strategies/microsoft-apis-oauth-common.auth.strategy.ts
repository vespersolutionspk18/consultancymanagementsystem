...
export abstract class MicrosoftAPIsOauthCommonStrategy extends PassportStrategy(
  ...
  constructor(cmsConfigService: CMSConfigService) {
    ...
    super({
      clientID: cmsConfigService.get('AUTH_MICROSOFT_CLIENT_ID'),
      clientSecret: cmsConfigService.get('AUTH_MICROSOFT_CLIENT_SECRET'),
      tenant: 'common',
      callbackURL: cmsConfigService.get('AUTH_MICROSOFT_APIS_CALLBACK_URL'),
      scope: scopes,
