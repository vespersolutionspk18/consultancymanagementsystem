...
import ms from 'ms';
import { assertIsDefinedOrThrow } from 'cms-shared/utils';
import { isWorkspaceActiveOrSuspended } from 'cms-shared/workspace';
...
export class AccessTokenService {
  ...
  >): Promise<AuthToken> {
    const expiresIn = this.cmsConfigService.get('ACCESS_TOKEN_EXPIRES_IN');
