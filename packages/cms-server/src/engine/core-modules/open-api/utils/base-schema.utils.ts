...
`,
      termsOfService:
        'https://github.com/cmshq/cms?tab=coc-ov-file#readme',
      contact: {
        email: 'felix@cms.com',
      },
      license: {
        name: 'AGPL-3.0',
        url: 'https://github.com/cmshq/cms?tab=License-1-ov-file#readme',
      },
      version: API_Version,
    },
    // Testing purposes
