...
describe('REST API Core Group By endpoint', () => {
  const testProjectId1 = randomUUID();
  const testProjectId2 = randomUUID();
  const testProjectId3 = randomUUID();
  const testProjectId4 = randomUUID();
    ...
    await makeGraphqlAPIRequest(
      createOneOperationFactory({
        ...
        data: {
          ...
          submissionDate: '2025-02-05T08:00:00.000Z', // Wednesday
          createdAt: '2020-02-05T08:00:00.000Z',
        },
      }),
    );
    ...
    await makeGraphqlAPIRequest(
      createOneOperationFactory({
        ...
        data: {
          ...
          companyId: testCompanyId1,
          submissionDate: '2025-02-06T08:00:00.000Z', // Thursday
          createdAt: '2020-02-05T08:00:00.000Z',
        },
      }),
    );
  ...
  it('groups by stage and submissionDate with records', async () => {
  ...
  it('groups by stage and submissionDate with records and filters', async () => {
