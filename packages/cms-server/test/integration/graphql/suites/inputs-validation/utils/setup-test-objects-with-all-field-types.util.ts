...
import { RelationType } from 'cms-shared/types';
import { computeMorphRelationFieldName } from 'cms-shared/utils';
import { v4 } from 'uuid';
      ...
      data: [
        {
          ...
          linksField: {
            ...
            primaryLinkLabel: 'cms - #1 Open source CRM',
            secondaryLinks: [
              {
                url: 'cms.com',
                label: 'cms - #1 Open source CRM',
              },
            ],
          },
          currencyField: {
