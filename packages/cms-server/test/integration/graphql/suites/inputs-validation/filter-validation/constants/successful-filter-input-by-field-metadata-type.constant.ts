...
export const successfulFilterInputByFieldMetadataType: {
  ...
  [FieldMetadataType.LINKS]: [
    {
      gqlFilterInput: {
        linksField: { primaryLinkUrl: { eq: 'cms.com' } },
      },
      restFilterInput: 'linksField.primaryLinkUrl[eq]:"cms.com"',
      validateFilter: (record: Record<string, any>) => {
        return record.linksField.primaryLinkUrl === 'cms.com';
      },
    },
    {
      gqlFilterInput: {
        linksField: {
          primaryLinkLabel: { eq: 'cms - #1 Open source CRM' },
        },
      },
      restFilterInput:
        'linksField.primaryLinkLabel[eq]:"cms - #1 Open source CRM"',
      validateFilter: (record: Record<string, any>) => {
        return (
          record.linksField.primaryLinkLabel === 'cms - #1 Open source CRM'
        );
      },
    },
    {
      gqlFilterInput: { linksField: { secondaryLinks: { like: '%cms%' } } },
      restFilterInput: 'linksField.secondaryLinks[like]:"%cms%"',
      validateFilter: (record: Record<string, any>) => {
