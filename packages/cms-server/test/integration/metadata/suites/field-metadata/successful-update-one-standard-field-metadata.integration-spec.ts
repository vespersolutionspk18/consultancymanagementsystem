...
describe('Standard field metadata update should succeed', () => {
  ...
  beforeAll(async () => {
    ...
    const projectObject = objects.find(
      (o) => o.nameSingular === 'project',
    );

    jestExpectToBeDefined(projectObject?.fieldsList);

    opportunityObjectFields.push(...projectObject.fieldsList);
