...
### Documentation Files
- **69 MDX files** copied from cms-website to cms-docs
...
3. Set subdirectory to `packages/cms-docs`
...
6. **Deprecate cms-website docs** - Once migration is confirmed working
