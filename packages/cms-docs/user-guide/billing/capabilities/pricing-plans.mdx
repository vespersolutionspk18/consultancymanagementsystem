---
title: Pricing Plans
description: Learn about CMS's pricing plans and how to switch between them.
---

## Overview

CMS offers flexible pricing to fit teams of all sizes, whether you prefer cloud hosting or self-hosting.
...
### Free (Self-Hosted)
Host CMS on your own infrastructure at no cost:
