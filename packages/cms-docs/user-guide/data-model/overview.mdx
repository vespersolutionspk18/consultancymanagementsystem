...
Every business works differently. Customizing your data model means you can shape CMS around **your** processes instead of forcing yours into a rigid system.
