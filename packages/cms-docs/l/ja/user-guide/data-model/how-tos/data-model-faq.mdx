...
description: Frequently asked questions about CMS's data model.
---
...
<AccordionGroup>
  ...
  <Accordion title="Can I rename a standard object?">
    You can rename the label of standard objects (People, Companies, Opportunities), but not their API names. The API names are fixed for consistency across all CMS workspaces.
  </Accordion>
