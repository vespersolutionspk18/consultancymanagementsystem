...
```bash
npx nx run cms-front:lint # pass --fix to fix lint errors
```
...
```bash
npx nx run cms-front:test # spusťte jest testy
npx nx run cms-front:storybook:serve:dev # spusťte storybook
npx nx run cms-front:storybook:test # spusťte testy # (vyžaduje, aby byl spuštěn yarn storybook:serve:dev)
npx nx run cms-front:storybook:coverage # (vyžaduje, aby byl spuštěn yarn storybook:serve:dev)
```
