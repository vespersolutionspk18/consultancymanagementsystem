...
<Warning>
  **Instalujete poprvé?** Postupujte podle [průvodce instalací Docker Compose](/l/cs/developers/self-host/capabilities/docker-compose) k rozchození CMS, a poté se sem vraťte pro konfiguraci.
</Warning>

CMS nabízí **dvě konfigurační režimy** pro různé potřeby nasazení:
...
1. Access your CMS instance (usually `http://localhost:3000`)
...
<Warning>
  ...
  [Kompletní technická referenční příručka →](https://github.com/cmshq/cms/blob/main/packages/cms-server/src/engine/core-modules/cms-config/config-variables.ts)
</Warning>
...
[Zobrazit relevantní zdrojový kód](https://github.com/cmshq/cms/blob/main/packages/cms-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
  Uživatelé musí mít [Licence Microsoft 365](https://admin.microsoft.com/Adminportal/Home), aby mohli používat API Kalendáře a Zpráv. Bez něj nebudou moci synchronizovat svůj účet na CMS.
</Warning>
...
[Zobrazit relevantní zdrojový kód](https://github.com/cmshq/cms/blob/main/packages/cms-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
