...
description: Kompletní návod krok za krokem, jak naformátovat data pro import do CMS.
---
...
**Toto je nejdůležitější krok.** Ukázkový soubor ukazuje přesné názvy sloupců a formát, který CMS očekává.
...
CMS vynucuje jedinečnost u některých polí. Duplicity způsobí chyby při importu.
...
3. Zkontrolujte duplicity, které už v CMS existují
...
* Musí být jedinečné (žádné duplicity v souboru ani v CMS)
...
* Musí být jedinečné v rámci vašeho souboru i v CMS
...
* **Odkazy / Štítek odkazu**: `CMS`
* **Odkazy / URL odkazu**: `https://cms.com`
...
* **Volitelné**: CMS automaticky generuje ID, pokud nejsou zadána
...
* Nadřazený záznam musí v CMS již existovat
...
## Krok 6: Ujistěte se, že pole v CMS existují
