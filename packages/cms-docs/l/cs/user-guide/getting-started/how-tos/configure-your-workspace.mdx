...
description: Každý podnik funguje jinak. Start with these 3 steps to shape CMS around your needs.
---

<Note>**Quick Win**: Start with connecting your mailbox. To vám dává okamžitou hodnotu a pomáhá vašemu týmu vidět CMS v akci s reálnými daty. You can do so under Settings → Accounts.</Note>

## 1. Přizpůsobte si svůj datový model

CMS nabízí flexibilitu, kterou potřebujete pro tvarování datového modelu, který nejlépe podpoří vaši každodenní práci.
...
Přinesení vašich stávajících dat do CMS dává vašemu týmu od začátku kontext.

### Připojte svou e-mailovou schránku

Pokud jste tak neučinili při vytváření svého pracovního prostoru, připojte svůj **Google nebo Microsoft účet** v Nastavení → Účty. To umožňuje CMS:
