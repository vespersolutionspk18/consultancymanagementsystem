...
The command menu gives you **quick access to actions** in CMS. K němu můžete přistoupit dvěma způsoby:
...
* Přistupujte k smazaným záznamům (CMS podporuje logické i trvalé mazání)
