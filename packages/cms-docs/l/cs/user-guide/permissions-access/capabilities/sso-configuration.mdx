...
Single Sign-On (SSO) allows your team members to log into CMS using your organization's identity provider. This provides:
...
* Admin access to CMS workspace

<Note>
  **For self-hosting users willing to set up SSO**, reach out to contact@cms.com
</Note>
...
* Remove them from the CMS workspace
...
* **Group mapping**: Map IdP groups to CMS roles (if available)
* **Offboarding process**: Include CMS in your deprovisioning workflow
