...
The command menu gives you **quick access to actions** in CMS. Вы можете получить к нему доступ двумя способами:
...
* Получать доступ к удалённым записям (в CMS поддерживаются мягкое и жёсткое удаление)
