...
Стандартные объекты - это предварительно определенные сущности в вашем рабочем пространстве, которые помогут вам начать работу. Они являются частью общей модели данных, доступной всем пользователям CMS. Вы можете использовать их как есть, настраивать их или деактивировать.
