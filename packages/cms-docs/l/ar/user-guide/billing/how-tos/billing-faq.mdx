...
<AccordionGroup>
  <Accordion title="هل يمكنني استخدام CMS مجانًا أثناء الاستضافة الذاتية؟">
    نعم، يمكنك استخدام CMS مجانًا أثناء الاستضافة الذاتية. You will get access to everything included in the Pro (Cloud) plan, except the support from our core-team. الدعم متاح عبر مجتمعنا في Discord.
  ...
  <Accordion title="هل تقدمون مقاعد مجانية للمستخدمين العارضين فقط؟">
    نحن لا نقدم مقاعد مجانية. التسعير يكون لكل مستخدم وكل مستخدم يحتاج إلى ترخيص للوصول إلى CMS.
  </Accordion>
