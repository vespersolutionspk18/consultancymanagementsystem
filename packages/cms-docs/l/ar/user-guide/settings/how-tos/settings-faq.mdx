...
description: Frequently asked questions about CMS settings.
...
<AccordionGroup>
  ...
  <Accordion title="Can I change my email address?">
    To change your email address, please reach out to [contact@cms.com](mailto:contact@cms.com).
  </Accordion>
...
<AccordionGroup>
  <Accordion title="هل يمكنني تخصيص دومين مساحة العمل الخاصة بي؟">
    ...
    * **Subdomain**: Use a CMS subdomain like `yourcompany.cms.com`
