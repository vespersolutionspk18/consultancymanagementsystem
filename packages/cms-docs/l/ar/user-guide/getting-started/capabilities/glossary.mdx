---
title: Glossary
description: تعرّف على المصطلحات الأساسية المستخدمة في CMS.
---

## واجهة برمجة التطبيقات

واجهة برمجة التطبيقات (API) تتيح لك ربط CMS بأنظمة برمجية أخرى وبناء تكاملات مخصصة.
...
المهام في CMS CRM هي أنشطة مُسندة تتعلق بجهات اتصال أو حسابات أو فرص.
...
الويب هوكس هي رسائل آلية ترسل من CMS إلى تطبيقات أخرى عند حدوث أحداث معينة، مما يتيح مزامنة البيانات في الوقت الفعلي.
...
`مساحة العمل` تمثل عادةً شركة تستخدم CMS. تحتوي على جميع السجلات والبيانات التي تدخلها أنت وأعضاء فريقك إلى CMS.
لها اسم نطاق واحد، وهو عادةً الاسم الذي تستخدمه شركتك لعناوين البريد الإلكتروني للموظفين.

## أعضاء مساحة العمل

أعضاء مساحة العمل هم مستخدمو CMS من فريقك الذين لديهم حق الوصول إلى مساحة العمل الخاصة بك. يمكن تعيينهم كمالكين أو معينين للسجلات.
