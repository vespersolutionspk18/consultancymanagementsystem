...
The command menu gives you **quick access to actions** in CMS. يمكنك الوصول إليها بطريقتين:
...
* إنشاء عروض جديدة
* الوصول إلى السجلات المحذوفة (يدعم CMS عمليات الحذف المنطقي والدائم)
