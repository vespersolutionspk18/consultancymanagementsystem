...
1. انتقل إلى [الاشتراك في CMS](https://app.cms.com).
...
للاستفسارات أو المساعدة، تواصل مع فريق الدعم المتخصص عبر [contact@cms.com](mailto:contact@cms.com) أو أرسل رسالة على [Discord](https://discord.gg/cx5n4Jzs57).
