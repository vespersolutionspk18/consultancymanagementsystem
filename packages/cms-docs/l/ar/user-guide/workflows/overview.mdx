...
تم تصميم CMS لتوفير أقصى قدر من المرونة للمستخدمين. بدلاً من إجبارك على تكييف عمليات عملك مع ميزات ثابتة ومعدة مسبقًا، تتيح تدفقات العمل لك بناء الأتمتة التي تُنشئ نظام إدارة علاقات العملاء (CRM) الأنسب لحالات الاستخدام الفريدة الخاصة بك.

تدفقات العمل هي ميزة داخل تطبيق CMS لبناء هذه الأتمتة. توفر لك لبنات البناء لإنشاء ما تحتاجه عملك تمامًا، عند الحاجة إليه.
...
2. **إدخال البيانات في CMS وخارجها**: اربط CMS من خلال النداءات البرمجية (API) وإشعارات الويب (webhooks) بقاعدة البيانات الخاصة بك والأدوات الأخرى.
