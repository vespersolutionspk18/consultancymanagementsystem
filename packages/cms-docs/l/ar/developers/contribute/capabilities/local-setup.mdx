...
description: The guide for contributors (or curious developers) who want to run CMS locally.
---
...
<Tabs>
  <Tab title="Linux و MacOS">
    قبل أن تتمكن من تثبيت واستخدام CMS، تأكد من تثبيت الأمور التالية على جهاز الكمبيوتر الخاص بك:
...
يتطلب CMS مخزن بيانات Redis لتقديم أفضل أداء
...
لبناء خادم CMS وزرع بعض البيانات في قاعدة البيانات الخاصة بك، قم بتشغيل الأمر التالي:
...
## الخطوة الثامنة: استخدم CMS

**الواجهة الأمامية**

ستكون واجهة CMS الأمامية تعمل على  [http://localhost:3001](http://localhost:3001).
يمكنك تسجيل الدخول باستخدام حساب العرض التوضيحي الافتراضي: `tim@apple.dev` (كلمة المرور: `tim@apple.dev`)

**الخلفية**

* سيكون خادم CMS متصلاً ويعمل على [http://localhost:3000](http://localhost:3000)
