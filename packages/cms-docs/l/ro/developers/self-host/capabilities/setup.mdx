...
<Warning>
  **Prima instalare?** Urmați [ghidul de instalare Docker Compose](/l/ro/developers/self-host/capabilities/docker-compose) pentru a rula CMS, apoi reveniți aici pentru configurare.
</Warning>

CMS oferă **două moduri de configurare** pentru a se potrivi nevoilor diferite de implementare:
...
1. Accesați instanța dumneavoastră CMS (de obicei `http://localhost:3000`)
...
<Warning>
  ...
  [Referință tehnică completă →](https://github.com/cmshq/cms/blob/main/packages/cms-server/src/engine/core-modules/cms-config/config-variables.ts)
</Warning>
...
[Consultați codul sursă relevant](https://github.com/cmshq/cms/blob/main/packages/cms-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
  Utilizatorii trebuie să aibă un [Licență Microsoft 365](https://admin.microsoft.com/Adminportal/Home) pentru a putea utiliza API-ul Calendar și Mesagerie. Nu vor putea sincroniza contul lor pe CMS fără una.
</Warning>
...
[Consultați codul sursă relevant](https://github.com/cmshq/cms/blob/main/packages/cms-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
