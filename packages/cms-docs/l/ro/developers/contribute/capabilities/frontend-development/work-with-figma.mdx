...
info: Learn how you can collaborate with CMS's Figma
---
...
1. **Accesează linkul partajat:** Poți accesa fișierul Figma al proiectului [aici](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/CMS).
...
On the left sidebar, you can access the different pages of CMS's Figma. Acestea sunt organizate astfel:
