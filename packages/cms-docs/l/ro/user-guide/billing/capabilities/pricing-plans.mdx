...
description: Aflați despre planurile tarifare ale CMS și cum să comutați între ele.
---

## Prezentare generală

CMS oferă prețuri flexibile care se potrivesc echipelor de orice dimensiune, fie că preferați găzduirea în cloud sau autogăzduirea.
...
Găzduiți CMS pe propria infrastructură, fără costuri:
...
* **Funcționalități premium**: integrare SSO și permisiuni la nivel de rând
* Asistență din partea echipei CMS
