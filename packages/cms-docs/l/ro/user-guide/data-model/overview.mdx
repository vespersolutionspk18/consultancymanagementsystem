...
CMS comes with standard objects:
...
Fiecare afacere funcționează diferit. Customizing your data model means you can shape CMS around **your** processes instead of forcing yours into a rigid system.

CMS offers full flexibility:
...
Identify the main concepts you work with. CMS already provides:
