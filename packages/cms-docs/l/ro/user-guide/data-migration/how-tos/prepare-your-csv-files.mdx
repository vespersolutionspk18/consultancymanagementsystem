...
description: Ghid complet, pas cu pas, pentru a formata datele pentru import în CMS.
---
...
**Acesta este cel mai important pas.** Fișierul de mostră vă arată exact denumirile de coloane și formatul pe care îl așteaptă CMS.
...
CMS impune unicitatea pentru anumite câmpuri. Valorile duplicate vor provoca erori la import.
...
3. Verificați duplicatele care există deja în CMS
...
* Trebuie să fie unic (fără duplicate în fișier sau în CMS)
...
* Trebuie să fie unic în fișierul dvs. și în CMS
...
* **Linkuri / Etichetă link**: `CMS`
* **Linkuri / URL link**: `https://cms.com`
...
* **Opțional**: CMS generează automat ID-uri dacă nu sunt furnizate
...
* Înregistrarea părinte trebuie să existe deja în CMS
...
## Pasul 6: Asigurați-vă că câmpurile există în CMS
