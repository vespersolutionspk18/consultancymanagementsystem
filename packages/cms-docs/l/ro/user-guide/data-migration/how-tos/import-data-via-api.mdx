...
description: When and how to use CMS's APIs for large-scale data imports.
---

## Prezentare generală

CMS provides both **GraphQL** and **REST APIs** for programmatic data import. Use the API when CSV import isn't practical for your data volume or when you need automated, recurring imports.
...
CMS enforces rate limits to ensure system stability:
...
* Verify formats match CMS's requirements (see [Field Mapping](/l/ro/user-guide/data-migration/capabilities/field-mapping))
...
* Verify data appears correctly in CMS
...
Contact us at [contact@cms.com](mailto:contact@cms.com) or explore our [Implementation Services](/l/ro/user-guide/getting-started/capabilities/implementation-services).
