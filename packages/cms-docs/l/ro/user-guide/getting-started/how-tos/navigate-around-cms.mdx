...
The command menu gives you **quick access to actions** in CMS. Puteți accesa în două moduri:
...
* Accesați înregistrările șterse (CMS acceptă ștergeri temporare și permanente)
