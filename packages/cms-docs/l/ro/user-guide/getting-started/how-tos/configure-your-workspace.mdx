...
description: Fiecare afacere funcționează diferit. Start with these 3 steps to shape CMS around your needs.
---

<Note>**Quick Win**: Start with connecting your mailbox. Acest lucru îți oferă valoare imediată și ajută echipa ta să vadă CMS în acțiune cu date reale. You can do so under Settings → Accounts.</Note>

## 1. Personalizează modelul tău de date

CMS oferă flexibilitatea de care ai nevoie pentru a modela modelul de date care va susține cel mai bine activitățile tale zilnice.
...
Importarea datelor existente în CMS oferă echipei tale context de la început.

### Conectează-ți căsuța de e-mail

Dacă nu ai făcut asta atunci când ai creat spațiul de lucru, conectează-ți **contul Google sau Microsoft** în setări → Conturi. Acest lucru permite CMS să:
