---
title: Glosar
description: Familiarizați-vă cu terminologia esențială utilizată în CMS.
---

## API

API (Interfața de Programare a Aplicațiilor) permite conectarea CMS cu alte sisteme software și construirea de integrări personalizate.
...
Oportunitățile în CMS CRM sunt potențiale afaceri sau vânzări cu conturi sau contacte.
...
Sarcinile în CMS CRM sunt activități atribuite care au legătură cu contacte, conturi sau oportunități.
...
Webhook-urile sunt mesaje automate trimise de la CMS către alte aplicații atunci când au loc evenimente specifice, permițând sincronizarea datelor în timp real.
...
Un `Spațiu de lucru` reprezintă de obicei o companie care folosește CMS. Conține toate înregistrările și datele pe care dvs. și membrii echipei dvs. le adăugați la CMS.
...
Membrii spațiului de lucru sunt utilizatorii CMS din echipa dvs. care au acces la spațiul dvs. de lucru. Ei pot fi desemnați ca proprietari sau asignați pentru înregistrări.
