...
description: Complete step-by-step guide to format your data for import into CMS.
---
...
<Note>For datasets larger than 10,000 records, split into multiple files or use the [API import](/l/ko/user-guide/data-migration/how-tos/import-data-via-api).</Note>

## Step 2: Download the Sample File

**This is the most important step.** The sample file shows you the exact column names and format CMS expects.
...
CMS enforces uniqueness on certain fields. Duplicates will cause import errors.
...
3. Check for duplicates that already exist in CMS
...
* Must be unique (no duplicates in file or in CMS)
...
* Must be unique within your file and in CMS
...
* **Links / Link Label**: `CMS`
* **Links / Link URL**: `https://cms.com`

For secondary links, use the **Links / Secondary Links** column:

```
[{"url":"https://cms.com","label":"CMS"}]
```
...
* **Optional**: CMS auto-generates IDs if not provided
...
* The parent record must already exist in CMS
...
## Step 6: Ensure Fields Exist in CMS
