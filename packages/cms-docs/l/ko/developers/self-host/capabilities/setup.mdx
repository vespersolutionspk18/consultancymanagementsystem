...
<Warning>
  **First time installing?** Follow the [Docker Compose installation guide](/l/ko/developers/self-host/capabilities/docker-compose) to get CMS running, then return here for configuration.
</Warning>
