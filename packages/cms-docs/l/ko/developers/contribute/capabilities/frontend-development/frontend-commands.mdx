...
```bash
npx nx run cms-front:test # run jest tests
npx nx run cms-front:storybook:serve:dev # run storybook
npx nx run cms-front:storybook:test # run tests # (needs yarn storybook:serve:dev to be running)
npx nx run cms-front:storybook:coverage # (needs yarn storybook:serve:dev to be running)
```
