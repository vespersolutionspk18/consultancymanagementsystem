---
title: Seleziona
image: /images/user-guide/what-is-cms/20.png
---

<Frame>
  <img src="/images/user-guide/what-is-cms/20.png" alt="Intestazione" />
</Frame>
...
<Tabs>
  <Tab title="Utilizzo">
    ...
    import { IconCMSStar } from 'cms-ui/display';
      ...
      return (
        <RecoilRoot>
          <Select
            ...
            options={[
              { value: 'option1', label: 'Option A', Icon: IconCMSStar },
              { value: 'option2', label: 'Option B', Icon: IconCMSStar },
            ]}
            value="option1"
          />
        </RecoilRoot>
