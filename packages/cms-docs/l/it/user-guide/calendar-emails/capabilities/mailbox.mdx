...
CMS collega automaticamente le email dalle tue caselle di posta connesse ai relativi record CRM, mantenendo la cronologia di comunicazione in un unico posto.
...
* **Email mancanti**: Verifica se:
  ...
  * La creazione automatica dei contatti è disabilitata (le email necessitano di record CMS esistenti)
