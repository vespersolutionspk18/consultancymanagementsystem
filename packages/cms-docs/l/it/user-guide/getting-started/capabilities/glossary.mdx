---
title: Glossario
description: Familiarizza con la terminologia essenziale utilizzata in CMS.
---

## API

Le API (Interfaccia di Programmazione delle Applicazioni) ti consentono di connettere CMS con altri sistemi software e creare integrazioni personalizzate.
...
Le Opportunità in CMS CRM sono potenziali accordi o vendite con aziende o contatti.
...
Le Attività in CMS CRM sono attività assegnate relative a contatti, aziende o opportunità.
...
Webhooks are automated messages sent from CMS to other applications when specific events occur, enabling real-time data synchronization.
...
Un `Workspace` rappresenta tipicamente un'azienda che utilizza CMS. Contiene tutti i record e i dati che tu e i membri del tuo team aggiungete a CMS.
...
I Membri del Workspace sono gli utenti di CMS del tuo team che hanno accesso al tuo Workspace. Possono essere assegnati come proprietari o assegnatari per i record.
