...
The command menu gives you **quick access to actions** in CMS. Puoi accedervi in due modi:
...
* Crea nuove viste
* Accedi ai record eliminati (CMS supporta eliminazioni temporanee e definitive)
