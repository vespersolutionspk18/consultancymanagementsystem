...
description: Guida completa passo passo per formattare i tuoi dati per l'importazione in CMS.
---
...
**Questo è il passaggio più importante.** Il file di esempio ti mostra i nomi delle colonne e il formato esatti che CMS si aspetta.
...
CMS impone l'unicità su alcuni campi. I duplicati causeranno errori di importazione.
...
3. Verifica la presenza di duplicati già esistenti in CMS
...
* Deve essere univoco (nessun duplicato nel file o in CMS)
...
* Deve essere univoco all'interno del tuo file e in CMS
...
* **Link / Etichetta del link**: `CMS`
* **Link / URL del link**: `https://cms.com`
...
* **Opzionale**: CMS genera automaticamente gli ID se non forniti
...
* Il record padre deve già esistere in CMS
...
## Passaggio 6: Verifica che i campi esistano in CMS
