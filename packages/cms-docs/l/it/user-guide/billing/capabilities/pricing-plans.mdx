...
description: Scopri i piani tariffari di CMS e come passare da uno all'altro.
---

## Panoramica

CMS offre prezzi flessibili per team di ogni dimensione, sia con hosting cloud sia con self‑hosting.
...
Esegui CMS sulla tua infrastruttura senza costi:
