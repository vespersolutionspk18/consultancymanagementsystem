...
description: Learn how to build automations in CMS.
...
CMS è stato creato per offrire la massima flessibilità ai suoi utenti. Piuttosto che costringerti ad adattare i tuoi processi aziendali a funzionalità rigide e predefinite, i workflow ti consentono di creare automazioni che creano il CRM che meglio supporta i tuoi casi d'uso aziendali unici.

I workflow sono la funzione in-app di CMS per creare queste automazioni. Ti forniscono gli elementi costitutivi per creare esattamente ciò di cui la tua attività ha bisogno, quando ne ha bisogno.
...
2. **Portare i dati dentro e fuori da CMS**: Collega CMS tramite chiamate API e webhooks al tuo database e ad altri strumenti.
...
* **Form**: Get inputs from users within CMS UI at the time of execution
