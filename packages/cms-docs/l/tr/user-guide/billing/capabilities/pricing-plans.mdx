...
description: CMS'nin fiyatlandırma planlarını ve bunlar arasında nasıl geçiş yapacağınızı öğrenin.
---

## Genel Bakış

İster bulut barındırma ister kendi kendine barındırmayı tercih edin, CMS her ölçekte ekibe uyacak esnek fiyatlandırma sunar.
...
CMS'yi kendi altyapınızda hiçbir ücret ödemeden barındırın:
