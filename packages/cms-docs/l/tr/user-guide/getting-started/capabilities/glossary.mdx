---
title: Sözlük
description: CMS'de kullanılan temel terminolojiyle tanışın.
---

## API

API (Uygulama Programlama Arayüzü), CMS'yi diğer yazılım sistemleriyle bağlamanızı ve özel entegrasyonlar oluşturmanızı sağlar.
...
CMS CRM'deki Fırsatlar, hesaplar veya kişilerle potansiyel anlaşmalar veya satışlardır.
...
CMS CRM'deki Görevler, kişilere, hesaplara veya fırsatlara ilişkin atanmış aktiviteleridir.
...
Webhook'lar, belirli olaylar gerçekleştiğinde CMS'den diğer uygulamalara gönderilen otomatik mesajlardır ve gerçek zamanlı veri senkronizasyonu sağlar.
...
Bir `İş Alanı` genellikle CMS'yi kullanan bir şirketi temsil eder. It holds all the records and data that you and your team members add to CMS.
Tek bir alan adını barındırır, bu genellikle çalışan e-posta adresleri için şirketinizin kullandığı alan adıdır.

## İş Alanı Üyeleri

İş Alanı Üyeleri, ekibinizdeki CMS kullanıcılarıdır ve iş alanınıza erişebilirler. Kayıtlar için sahip veya atanan olarak görevlendirilebilirler.
