...
The command menu gives you **quick access to actions** in CMS. İki yöntemle erişebilirsiniz:
...
* Silinen kayıtlara erişin (CMS yumuşak ve kalıcı silmeleri destekler)
