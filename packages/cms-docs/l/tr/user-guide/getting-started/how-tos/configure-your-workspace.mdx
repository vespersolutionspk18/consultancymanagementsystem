...
description: Her iş farklı çalışır. Start with these 3 steps to shape CMS around your needs.
---

<Note>**Quick Win**: Start with connecting your mailbox. Bu size anında değer katar ve ekibinizin gerçek verilerle CMS'yi çalışırken görmesine yardımcı olur. You can do so under Settings → Accounts.</Note>

## 1. Veri modelinizi özelleştirin

CMS, günlük ihtiyaçlarınızı en iyi şekilde destekleyecek veri modelini şekillendirmeniz için ihtiyaç duyduğunuz esnekliği sunar.
...
Mevcut verilerinizi CMS'ye getirmek, ekibinize baştan itibaren bağlam sunar.

### Posta kutunuzu bağlayın

Çalışma alanınızı oluştururken bunu yapmadıysanız, Ayarlar → Hesaplar altında **Google veya Microsoft hesabınızı** bağlayın. Bu, CMS'ye şunları yapma olanağı tanır:
