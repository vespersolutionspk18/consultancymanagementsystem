...
description: CMS iş akışlarında kullanılabilen eylemler hakkında bilgi edinin.
---
...
<Note>
  You can only send emails from mailboxes synced to your own CMS account. Sending from other team members' mailboxes (e.g., the account owner's email) is on the roadmap.
</Note>
