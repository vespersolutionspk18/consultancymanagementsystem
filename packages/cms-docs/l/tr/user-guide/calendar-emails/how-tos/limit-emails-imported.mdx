...
description: Hangi e-postaların CMS'ye içe aktarılacağını kontrol edin.
---

## Genel Bakış

Varsayılan olarak, CMS bağlı posta kutunuzdan tüm harici e-postaları senkronize eder. **Klasör seçimi** ve **görünürlük ayarlarını** kullanarak içe aktarılanları sınırlayabilirsiniz.
