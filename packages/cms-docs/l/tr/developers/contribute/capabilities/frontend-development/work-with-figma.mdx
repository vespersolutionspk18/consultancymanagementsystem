...
1. **Access the shared link:** You can access the project's Figma file [here](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/CMS).
...
On the left sidebar, you can access the different pages of CMS's Figma. Bu şekilde organize edilmişlerdir:
