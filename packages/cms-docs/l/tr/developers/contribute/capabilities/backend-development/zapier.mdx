...
Zapier'i kullanarak CMS'yi 3000+ uygulama ile zahmetsizce senkronize edin. Görevleri otomatikleştirin, verimliliği artırın ve müşteri ilişkilerinizi güçlendirin!
...
`packages/cms-zapier` klasöründen şunu çalıştırın:
