...
<Warning>
  **First time installing?** Follow the [Docker Compose installation guide](/l/tr/developers/self-host/capabilities/docker-compose) to get CMS running, then return here for configuration.
</Warning>
...
1. CMS örneğinize erişin (genellikle `http://localhost:3000`)
...
<Warning>
  ...
  [Tam teknik referans →](https://github.com/cmshq/cms/blob/main/packages/cms-server/src/engine/core-modules/cms-config/config-variables.ts)
</Warning>
...
[İlgili kaynak kodunu görün](https://github.com/cmshq/cms/blob/main/packages/cms-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
  Kullanıcıların Takvim ve Mesajlaşma API'sini kullanabilmesi için bir [Microsoft 365 Lisansı](https://admin.microsoft.com/Adminportal/Home) olması gerekir. Biri olmadan hesaplarını CMS'de eşitleyemeyecekler.
</Warning>
...
[İlgili kaynak kodunu görün](https://github.com/cmshq/cms/blob/main/packages/cms-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
