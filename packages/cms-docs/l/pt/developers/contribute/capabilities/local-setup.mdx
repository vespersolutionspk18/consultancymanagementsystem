...
<Tabs>
  <Tab title="Linux and MacOS">
    Before you can install and use CMS, make sure you install the following on your computer:
...
CMS requires a redis cache to provide the best performance
...
To build CMS server and seed some data into your database, run the following command:
