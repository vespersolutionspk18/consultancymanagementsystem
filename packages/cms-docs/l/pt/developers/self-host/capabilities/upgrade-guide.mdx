...
1. In a terminal, on the host where CMS is running, turn off CMS: `docker compose down`
...
3. Bring CMS back online with `docker compose up -d`
...
If you encounter any runtime issues after upgrading, you may need to flush your cache to ensure it's synchronized with the latest changes. Run this command in your cms-server container:
...
Upgrade your CMS instance to use v0.55 image
...
In your `cms-server` container, run:

```bash
yarn command:prod cache:flush
```

This issue is specific to this CMS version and should not be required for future upgrades.
...
It should always be in the range of your current CMS's instance `major.minor` version, you can view your instance version in the admin panel (at `/settings/admin-panel`, accessible if your user has `canAccessFullAdminPanel` property set to true in the database) or by running `echo $APP_VERSION` in your `cms-server` container.

To fix a desynchronized workspace version, you will have to upgrade from the corresponding cms's version following related upgrade guide sequentially and so on until it reaches desired version.
...
Upgrade your CMS instance to use v0.52 image
...
Upgrade your CMS instance to use v0.51 image
...
Upgrade your CMS instance to use v0.50.0 image
...
Please update your local `docker-compose.yml` with [v0.50.0 docker-compose.yml](https://github.com/cmshq/cms/blob/v0.50.0/packages/cms-docker/docker-compose.yml)

### v0.43.0 to v0.44.0

Upgrade your CMS instance to use v0.44.0 image
...
Upgrade your CMS instance to use v0.43.0 image
...
2. Upgrade your docker-compose.yml to use postgres:16 image as in the [docker-compose.yml](https://raw.githubusercontent.com/cmshq/cms/main/packages/cms-docker/docker-compose.yml) file.
...
Upgrade your CMS instance to use v0.42.0 image
...
Upgrade your CMS instance to use v0.41.0 image
...
Upgrade your CMS instance to use v0.40.0 image
...
Upgrade your CMS instance to use v0.35.0 image
...
Upgrade your CMS instance to use v0.34.0 image
...
Upgrade your CMS instance to use v0.33.0 image
...
Starting from this version, cms-postgres image for DB became deprecated and cms-postgres-spilo is used instead.
If you want to keep using cms-postgres image, simply replace `cmscrm/cms-postgres:${TAG}` with `cmscrm/cms-postgres` in docker-compose.yml.

### v0.31.0 to v0.32.0

Upgrade your CMS instance to use v0.32.0 image
...
Upgrade your CMS instance to use v0.31.0 image
...
Upgrade your CMS instance to use v0.30.0 image

**Breaking change**:
To enhance performances, CMS now requires redis cache to be configured. We have updated our [docker-compose.yml](https://raw.githubusercontent.com/cmshq/cms/main/packages/cms-docker/docker-compose.yml) to reflect this.
...
Upgrade your CMS instance to use v0.24.0 image
...
Upgrade your CMS instance to use v0.23.0 image
...
Upgrade your CMS instance to use v0.22.0 image
