...
CMS supports two main methods for importing data:
...
<Note>For very large datasets (hundreds of thousands of records), use the API. Our [implementation partners](/l/pt/user-guide/getting-started/capabilities/implementation-services) can help run these scripts if needed.</Note>
...
5. Map your columns to CMS fields
