...
The command menu gives you **quick access to actions** in CMS. Sie können es auf zwei Weisen aufrufen:
...
* Auf gelöschte Datensätze zugreifen (CMS unterstützt weiches und hartes Löschen)
