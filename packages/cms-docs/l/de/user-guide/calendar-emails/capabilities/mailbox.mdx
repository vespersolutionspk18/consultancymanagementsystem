...
CMS verknüpft E-Mails automatisch aus Ihren verknüpften Postfächern mit den relevanten CRM-Datensätzen, um den gesamten Kommunikationsverlauf an einem Ort zu halten.
...
* **Fehlende E-Mails**: Prüfen Sie, ob:
  ...
  * Die automatische Erstellung von Kontakten deaktiviert ist (E-Mails benötigen vorhandene CMS-Datensätze)
