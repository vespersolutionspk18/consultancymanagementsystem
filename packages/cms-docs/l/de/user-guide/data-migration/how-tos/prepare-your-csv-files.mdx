...
description: Vollständige Schritt-für-Schritt-Anleitung zum Formatieren deiner Daten für den Import in CMS.
---
...
**Dies ist der wichtigste Schritt.** Die Beispieldatei zeigt dir die exakten Spaltennamen und das Format, das CMS erwartet.
...
CMS erzwingt die Eindeutigkeit bestimmter Felder. Duplikate führen zu Importfehlern.
...
3. Prüfe auf Duplikate, die in CMS bereits existieren
...
* Muss eindeutig sein (keine Duplikate in der Datei oder in CMS)
...
* Muss innerhalb deiner Datei und in CMS eindeutig sein
...
* **Optional**: CMS erstellt IDs automatisch, wenn sie nicht angegeben werden
...
* Der übergeordnete Datensatz muss bereits in CMS vorhanden sein
...
## Schritt 6: Sicherstellen, dass Felder in CMS vorhanden sind
