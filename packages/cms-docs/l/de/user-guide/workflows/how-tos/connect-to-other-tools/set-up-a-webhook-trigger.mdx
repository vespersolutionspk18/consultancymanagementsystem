...
| **Benutzerdefinierte Integrationen** | Ihre App → CMS-Automatisierung                 |
...
3. Sie erhalten eine eindeutige Webhook-URL wie:
   ```
   https://api.cms.com/webhooks/workflow/abc123...
   ```
...
```bash
curl -X POST https://api.cms.com/webhooks/workflow/abc123... \
