...
CMS wurde entwickelt, um den Nutzern maximale Flexibilität zu bieten. Rather than forcing you to adapt your business processes to rigid, pre-built features, workflows enable you to build automations that create the CRM that best supports your unique business use cases.

Workflows are CMS's in-app feature for building these automations. Sie bieten Ihnen die Bausteine, um genau das zu schaffen, was Ihr Unternehmen braucht, wann es das braucht.
...
2. **Daten in und aus CMS bringen**: Verbinden Sie CMS über API-Aufrufe und Webhooks mit Ihrer Datenbank und anderen Werkzeugen.
