...
description: Step-by-step guide to migrate your CMS self-hosted instance to CMS Cloud.
---

## Overview

This guide walks you through migrating your data from a CMS self-hosted instance to CMS Cloud. The process involves setting up your cloud workspace, exporting your data, and re-importing it.
...
1. Go to [app.cms.com](https://app.cms.com) and create a new workspace
...
See [How to Import Relations](/l/fr/user-guide/data-migration/how-tos/import-relations-between-objects-via-csv) for details on maintaining relationships.
...
For complex migrations or large datasets, contact us at [contact@cms.com](mailto:contact@cms.com) or explore our [Implementation Services](/l/fr/user-guide/getting-started/capabilities/implementation-services).
