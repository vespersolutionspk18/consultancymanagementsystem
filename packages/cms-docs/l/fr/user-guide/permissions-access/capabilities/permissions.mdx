...
CMS's permission system allows you to control access to three main areas:
...
<Note>
  You can only assign roles to existing workspace members. To invite new members, use [Member Management](/l/fr/user-guide/settings/capabilities/member-management).
</Note>
