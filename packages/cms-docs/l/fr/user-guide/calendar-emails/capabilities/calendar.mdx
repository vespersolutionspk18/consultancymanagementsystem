---
title: Calendar
description: Understanding calendar integration features in CMS.
---

**Note**: To connect your calendar and configure sync settings, visit [Email & Calendar Setup](/l/fr/user-guide/calendar-emails/overview).

## How Calendar Integration Works

CMS automatically syncs your calendar events and links them to the relevant CRM records, giving you a complete view of your meeting history with contacts and companies.
