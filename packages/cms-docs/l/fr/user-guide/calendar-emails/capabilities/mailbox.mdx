---
title: Mailbox
description: Understanding email integration features in CMS.
---

**Note**: To connect your email accounts and configure sync settings, visit [Email & Calendar Setup](/l/fr/user-guide/calendar-emails/overview).

## How Email Integration Works

CMS automatically links emails from your connected mailboxes to the relevant CRM records, keeping all communication history in one place.
...
* **Missing Emails**: Check if:
  ...
  * Contact auto-creation is disabled (emails need existing CMS records)
