...
<Warning>
  **First time installing?** Follow the [Docker Compose installation guide](/l/fr/developers/self-host/capabilities/docker-compose) to get CMS running, then return here for configuration.
</Warning>

CMS offers **two configuration modes** to suit different deployment needs:
...
<Warning>
  ...
  [Complete technical reference →](https://github.com/cmshq/cms/blob/main/packages/cms-server/src/engine/core-modules/cms-config/config-variables.ts)
</Warning>
...
[See relevant source code](https://github.com/cmshq/cms/blob/main/packages/cms-server/src/engine/core-modules/auth/utils/get-google-apis-oauth-scopes.ts#L4-L10)
...
<Warning>
  Users must have a [Microsoft 365 Licence](https://admin.microsoft.com/Adminportal/Home) to be able to use the Calendar and Messaging API. They will not be able to sync their account on CMS without one.
</Warning>
...
[See relevant source code](https://github.com/cmshq/cms/blob/main/packages/cms-server/src/engine/core-modules/auth/utils/get-microsoft-apis-oauth-scopes.ts#L2-L9)
