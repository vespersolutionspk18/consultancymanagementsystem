...
<Note>For datasets larger than 10,000 records, split into multiple files or use the [API import](/l/zh/user-guide/data-migration/how-tos/import-data-via-api).</Note>
