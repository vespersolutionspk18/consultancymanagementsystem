---
title: Dashboards
description: Learn the basics of reporting and dashboards in CMS.
...
Dashboards in CMS provide a visual way to track your key performance metrics and gain insights from your CRM data.
...
<Note>
  ...
  * Exporting dashboards and sharing with external users (non-CMS users) are not available at the moment.
