---
title: Can I Send Emails from CMS?
description: Information about sending emails directly from CMS.
---

## Current Status

CMS's email integration is designed to **sync and display** your email history. Emails cannot be composed or sent directly from CMS's interface.
...
While you can't send emails manually from CMS, you **can send emails automatically using Workflows**. This is useful for:
...
For email sequences and newsletters, we recommend using workflows to connect CMS to a dedicated email marketing tool.
...
Native email composition from within CMS is on our roadmap. Join our [GitHub discussions](https://github.com/cmshq/cms/discussions) to share your use case and help prioritize this feature.
