---
title: Glossary
description: Get familiar with essential terminology used in CMS.
---

## API

API (Application Programming Interface) allows you to connect CMS with other software systems and build custom integrations.
...
A `Workspace` typically represents a company using CMS. It holds all the records and data that you and your team members add to CMS.
It has a single domain name, which is typically the domain name your company uses for employee email addresses.

## Workspace Members

Workspace Members are the CMS users from your team who have access to your workspace. They can be assigned as owners or assignees for records.
