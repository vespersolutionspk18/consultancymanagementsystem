...
A sales pipeline in CMS is a Kanban view of your Opportunities object, where each column represents a stage in your sales process.
...
* [Kanban Views](/l/zh/user-guide/views-pipelines/capabilities/kanban-views) — aggregations and compact view
