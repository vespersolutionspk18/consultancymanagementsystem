...
export default defineConfig(({ command, mode }) => {
  ...
  const MAIN_CHUNK_SIZE_LIMIT = 8 * 1024 * 1024; // 8MB for main index chunk
  ...
  return {
    root: __dirname,
    cacheDir: '../../node_modules/.vite/packages/cms-front',
    ...
    resolve: {
      alias: {
        ...
        // https://github.com/cmshq/cms/pull/10782/files
        // This will likely be migrated to cms-ui package when built separately
