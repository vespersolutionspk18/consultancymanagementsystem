...
export const graphqlMocks = {
  handlers: [
            ...
            edges: [
              ...
              },
              {
                node: {
                  ...
                  label: 'Linkedin',
                  imageUrl: 'https://cms-icons.com/linkedin.com',
                  tsRankCD: 0.2,
                  tsRank: 0.12158542,
                },
                cursor: 'cursor-2',
              },
              {
                node: {
                  ...
                  objectNameSingular: 'company',
                  label: 'Libeo',
                  imageUrl: 'https://cms-icons.com/libeo.io',
                  tsRankCD: 0.2,
                  tsRank: 0.12158542,
                },
                cursor: 'cursor-3',
    ...
    graphql.query('FindManyProjects', () => {
      return HttpResponse.json({
        data: {
          projects: {
            edges: [],
          ...
          webhooks: [
            {
              __typename: 'Webhook',
              id: '1234',
              targetUrl: 'https://api.slackbot.io/webhooks/cms',
