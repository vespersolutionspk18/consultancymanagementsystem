...
export type Query = {
  ...
  getTimelineCalendarEventsFromProjectId: TimelineCalendarEventsWithTotal;
  getTimelineCalendarEventsFromPersonId: TimelineCalendarEventsWithTotal;
  getTimelineThreadsFromCompanyId: TimelineThreadsWithTotal;
  getTimelineThreadsFromProjectId: TimelineThreadsWithTotal;
...
export type QueryGetTimelineCalendarEventsFromProjectIdArgs = {
...
export type QueryGetTimelineThreadsFromProjectIdArgs = {
  projectId: Scalars['UUID'];
  page: Scalars['Int'];
  pageSize: Scalars['Int'];
};
