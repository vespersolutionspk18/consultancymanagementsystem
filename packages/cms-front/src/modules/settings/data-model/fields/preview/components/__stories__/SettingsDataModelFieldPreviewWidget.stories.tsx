...
const mockedProjectObjectMetadataItem =
  getMockObjectMetadataItemOrThrow('project');
...
const selectFieldMetadataItem = getMockFieldMetadataItemOrThrow({
  objectMetadataItem: mockedProjectObjectMetadataItem,
  fieldName: 'stage',
});
...
export const Select: Story = {
  args: {
    ...
    objectNameSingular: mockedProjectObjectMetadataItem.nameSingular,
  },
};
