...
//TODO : isIncludedInUniqueConstraint refactor - https://github.com/cmshq/core-team-issues/issues/1097
...
export const SETTINGS_COMPOSITE_FIELD_TYPE_CONFIGS = {
  ...
  [FieldMetadataType.EMAILS]: {
    ...
    exampleValues: [
      {
        primaryEmail: 'tim@cms.com',
        additionalEmails: [
          'tim@cms.com',
          'timapple@cms.com',
          'johnappletim@cms.com',
        ],
      },
      {
        primaryEmail: 'jane@cms.com',
        additionalEmails: ['jane@cms.com', 'jane.doe@cms.com'],
      },
      {
        primaryEmail: 'john@cms.com',
        additionalEmails: ['john.doe@cms.com'],
      },
    ],
    category: 'Basic',
  ...
  [FieldMetadataType.LINKS]: {
    ...
    exampleValues: [
      {
        primaryLinkUrl: 'cms.com',
        primaryLinkLabel: '',
        secondaryLinks: [{ url: 'cms.com', label: 'CMS' }],
      },
      {
        primaryLinkUrl: 'github.com/cmshq/cms',
        primaryLinkLabel: 'CMS Repo',
        secondaryLinks: [{ url: 'cms.com', label: '' }],
      },
      {
