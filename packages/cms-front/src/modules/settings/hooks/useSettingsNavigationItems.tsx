...
import {
  ...
  IconCurrencyDollar,
  IconDoorEnter,
  // IconHelpCircle, // Documentation removed
  IconHierarchy2,
  IconKey,
  IconLock,
  IconMail,
  IconMessage,
  // IconPlug, // Applications hidden
  // IconRocket, // Updates removed
  IconServer,
  IconSettings,
  IconSparkles,
  IconUserCircle,
...
const useSettingsNavigationItems = (): SettingsNavigationSection[] => {
  ...
  // Applications hidden - not needed
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        // Documentation removed - not needed
        // {
