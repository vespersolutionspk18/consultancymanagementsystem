...
import { AdvancedSettingsToggle } from 'cms-ui/navigation';
import { getOsControlSymbol } from 'cms-ui/utilities';
    ...
    children: (
      <>
        ...
        <NavigationDrawerSection>
          ...
          <NavigationDrawerItem label="Projects" Icon={IconTargetArrow} />
        </NavigationDrawerSection>
      </>
    ),
  },
