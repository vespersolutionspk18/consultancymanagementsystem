...
import { getTimelineThreadsFromProjectId } from '@/activities/emails/graphql/queries/getTimelineThreadsFromProjectId';
...
import { H1Title, H1TitleFontColor } from 'cms-ui/display';
import {
  AnimatedPlaceholder,
  ...
  const [query, queryName] =
    targetRecord.targetObjectNameSingular === CoreObjectNameSingular.Person
      ...
      : targetRecord.targetObjectNameSingular === CoreObjectNameSingular.Company
        ...
        : [getTimelineThreadsFromProjectId, 'getTimelineThreadsFromProjectId'];
