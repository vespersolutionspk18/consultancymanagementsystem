...
import { MUTATION_MAX_MERGE_RECORDS } from 'cms-shared/constants';
...
> = {
  ...
  [NoSelectionRecordActionKeys.GO_TO_OPPORTUNITIES]: {
    ...
    shouldBeRegistered: ({
      ...
      getTargetObjectReadPermission(CoreObjectNameSingular.Project) &&
      (objectMetadataItem?.nameSingular !== CoreObjectNameSingular.Project ||
        viewType === ActionViewType.SHOW_PAGE),
    component: (
      <ActionLink
        to={AppPath.RecordIndexPage}
        params={{ objectNamePlural: CoreObjectNamePlural.Project }}
      />
    ),
    hotKeys: ['G', 'O'],
  },
