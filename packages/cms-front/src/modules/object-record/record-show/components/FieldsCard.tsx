  ...
  return (
    <RecordFieldsScopeContextProvider value={{ scopeInstanceId: instanceId }}>
      <RecordFieldList
        ...
        excludeFieldNames={configuration?.excludeFieldNames}
        excludeRelationFieldNames={configuration?.excludeRelationFieldNames}
        includeRelationFieldNames={configuration?.includeRelationFieldNames}
        relationFieldLabelOverrides={configuration?.relationFieldLabelOverrides}
      />
