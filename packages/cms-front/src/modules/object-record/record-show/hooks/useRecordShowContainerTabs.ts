...
import { PROJECT_RECORD_LAYOUT } from '@/object-record/record-show/layouts/project-record-layout';
...
import { IconHome, useIcons } from 'cms-ui/display';
...
> = {
  ...
  [CoreObjectNameSingular.Project]: PROJECT_RECORD_LAYOUT,
