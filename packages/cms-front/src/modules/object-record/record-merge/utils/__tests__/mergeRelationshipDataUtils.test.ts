...
describe('mergeOneToManyRelationships', () => {
    ...
    const records: ObjectRecord[] = [
      {
        ...
        id: 'record1',
        projects: [
          { __typename: 'Project', id: 'opp1', name: 'Project 1' },
          { __typename: 'Project', id: 'opp2', name: 'Project 2' },
        ],
      },
      {
        __typename: 'Company',
        id: 'record2',
        projects: [
          { __typename: 'Project', id: 'opp2', name: 'Project 2' }, // Duplicate
          { __typename: 'Project', id: 'opp3', name: 'Project 3' },
        ],
      },
    ];

    const result = mergeOneToManyRelationships(records, 'projects');
    ...
    const records: ObjectRecord[] = [
      {
        __typename: 'Company',
        id: 'record1',
        projects: [{ __typename: 'Project', id: 'opp1', name: 'Project 1' }],
      },
      {
        __typename: 'Company',
        id: 'record2',
  ...
  it('should handle empty records array', () => {
    const result = mergeOneToManyRelationships([], 'projects');
