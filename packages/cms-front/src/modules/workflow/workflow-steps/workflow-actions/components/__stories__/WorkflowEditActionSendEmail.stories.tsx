...
import { ComponentDecorator, RouterDecorator } from 'cms-ui/testing';
...
const CONFIGURED_ACTION: WorkflowSendEmailAction = {
  ...
  settings: {
    input: {
      ...
      body: 'Dear Tim,\n\nWelcome to CMS! We are excited to have you on board.\n\nBest regards,\nThe Team',
      files: [],
    },
    outputSchema: {},
    errorHandlingOptions: {
...
export const Configured: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const emailInput = await canvas.findByText('tim@cms.com');
    expect(emailInput).toBeVisible();

    const subjectInput = await canvas.findByText('Welcome to CMS!');
