...
const projectObjectMetadataItem = getMockObjectMetadataItemOrThrow(
...
const projectStageField = getMockFieldMetadataItemOrThrow({
  objectMetadataItem: projectObjectMetadataItem,
  fieldName: 'stage',
});
...
const TEST_OPPORTUNITY_RECORD_ID = 'test-project-789';
...
const mockProjectRecord: ObjectRecord = {
  __typename: 'Project',
  ...
  submissionDate: '2025-12-31T00:00:00Z',
};
...
export const SelectFieldWidget: Story = {
  render: () => {
    const widget: PageLayoutWidget = {
      ...
      type: WidgetType.FIELD,
      title: 'Stage',
      objectMetadataId: projectObjectMetadataItem.id,
      gridPosition: {
        __typename: 'GridPosition',
        row: 9,
        column: 0,
      ...
      configuration: {
        __typename: 'FieldConfiguration',
        fieldMetadataId: projectStageField.id,
        layout: 'FIELD',
      },
      createdAt: '2024-01-01T00:00:00Z',
      updatedAt: '2024-01-01T00:00:00Z',
              ...
              <LayoutRenderingProvider
                value={{
                  ...
                  targetRecordIdentifier: {
                    id: TEST_OPPORTUNITY_RECORD_ID,
                    targetObjectNameSingular:
                      projectObjectMetadataItem.nameSingular,
                  },
                }}
              >
                <PageLayoutContentProvider
