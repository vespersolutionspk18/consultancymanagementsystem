...
describe('buildSignedPath', () => {
  ...
  it('should ignore absolute https urls', () => {
    expect(
      buildSignedPath({
        path: 'https://cmshq.github.io/placeholder-images/workspaces/cms-logo.png',
        token: 'tokenValue',
      }),
    ).toBe(
      'https://cmshq.github.io/placeholder-images/workspaces/cms-logo.png',
    );
  });
  ...
  it('should ignore absolute http urls', () => {
    expect(
      buildSignedPath({
        path: 'http://cmshq.github.io/placeholder-images/workspaces/cms-logo.png',
        token: 'tokenValue',
      }),
    ).toBe(
      'http://cmshq.github.io/placeholder-images/workspaces/cms-logo.png',
    );
  });
});
