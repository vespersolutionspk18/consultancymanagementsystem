...
export default [
  ...
  // TypeScript project-specific configuration
  {
    ...
    rules: {
      // Override import restrictions for cms-ui
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            ...
            {
              group: ['@lingui/*'],
              message: 'Lingui should not be used in cms-ui. Pass translatable strings as props from cms-front instead.',
            },
          ],
        },
      ],
      ...
      // Disable lingui rules for cms-ui - translations should be handled in cms-front
