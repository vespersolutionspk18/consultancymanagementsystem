...
A minimal hello-world application built with an alpha version of the cms-cli.

⚠️ Since this project uses an early alpha release, expect breaking changes and evolving features.

This example will gradually gain complexity and capabilities as the cms-cli matures with future updates.
...
- replace `<SET_YOUR_CMS_API_KEY>` and `<SET_YOUR_CMS_API_URL>` accordingly
