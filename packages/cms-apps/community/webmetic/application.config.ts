...
const config: ApplicationConfig = {
  ...
  description:
    'Automatically sync B2B website visitor data into CMS CRM. Identify companies visiting your website and track engagement without forms or manual entry.',
  applicationVariables: {
    ...
    CMS_API_URL: {
      ...
      description: 'CMS API URL (base URL of your CMS instance)',
      isSecret: false,
      value: '',
    },
    WEBMETIC_API_KEY: {
