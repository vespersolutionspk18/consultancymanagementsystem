...
const config: ApplicationConfig = {
  ...
  applicationVariables: {
    CMS_API_KEY: {
      ...
      value: '',
      description:
        'API key for the CMS CRM instance (used for authentication).',
    },
    AI_PROVIDER_API_KEY: {
    ...
    CMS_API_URL: {
      ...
      isSecret: false,
      value: 'https://unpaid-interns.cms.com',
      description:
        'The base URL for the CMS CRM server (e.g., https://your-instance.cms.com).',
    },
