import { type ApplicationConfig } from 'cms-sdk';

const config: ApplicationConfig = {
  universalIdentifier: 'a4df0c0f-c65e-44e5-8436-24814182d4ac',
  displayName: 'Fireflies',
  description: 'Sync Fireflies meeting summaries, sentiment, and action items into CMS.',
  icon: 'IconMicrophone',
  applicationVariables: {
    ...
    CMS_API_KEY: {
      ...
      description: 'CMS API key used when running scripts locally',
      //isSecret: true,
      value: '',
    },
    SERVER_URL: {
      universalIdentifier: '9b3a5e8e-5973-4e6b-a059-2966075652aa',
      description: 'Base URL for the CMS workspace (default: http://localhost:3000)',
