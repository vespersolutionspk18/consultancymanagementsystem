...
import { CMS_TEAM_MEMBERS } from '@/shared-utils/listTeamMembers';

export const metadata = {
  title: 'CMS - Contributors',
  description:
    'Discover the brilliant minds behind CMS.com. Meet our contributors and explore how their expertise contributes to making CMS the leading open-source CRM. Join our community today.',
...
const Contributors = async () => {
  ...
  const fitlerContributors = contributors
    ...
    .filter((contributor) => !CMS_TEAM_MEMBERS.includes(contributor.id))
    .map((contributor) => {
