...
const PACKAGE_PATH = path.resolve('packages/cms-sdk');
...
const main = () => {
  ...
  // Ensure top-level src/index.ts re-exports the root directories barrel so consumers can `import * from "cms-sdk"`
