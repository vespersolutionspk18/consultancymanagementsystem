...
const cmsSdkTypesMock = `
declare module 'cms-sdk' {
...
import { PermissionFlag, type RoleConfig } from 'cms-sdk';
...
import { type FunctionConfig } from 'cms-sdk';
...
const packageJsonMock = {
  ...
  scripts: {
    'create-entity': 'cms app add',
    dev: 'cms app dev',
    generate: 'cms app generate',
    sync: 'cms app sync',
    uninstall: 'cms app uninstall',
    auth: 'cms auth login',
  },
  dependencies: {
    'cms-sdk': '0.1.0',
...
const applicationConfigMock = `import { type ApplicationConfig } from 'cms-sdk';
...
describe('loadManifest (integration)', () => {
  ...
  beforeEach(async () => {
    ...
    write(
      appDirectory,
      'src/types/cms-sdk-application.d.ts',
      cmsSdkTypesMock,
    );
